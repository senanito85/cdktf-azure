...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Nullmodule)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nullResourceIdOutput", GoGetter: "NullResourceIdOutput"},
	...
	_jsii_.RegisterStruct(
		"nullmodule.NullmoduleConfig",
		reflect.TypeOf((*NullmoduleConfig)(nil)).Elem(),
	)
}
