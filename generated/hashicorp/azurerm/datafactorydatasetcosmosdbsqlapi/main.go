...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataFactoryDatasetCosmosdbSqlapi.DataFactoryDatasetCosmosdbSqlapi",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataFactoryDatasetCosmosdbSqlapi.DataFactoryDatasetCosmosdbSqlapiSchemaColumn",
		reflect.TypeOf((*DataFactoryDatasetCosmosdbSqlapiSchemaColumn)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataFactoryDatasetCosmosdbSqlapi.DataFactoryDatasetCosmosdbSqlapiSchemaColumnList",
	...
	_jsii_.RegisterClass(
		"azurerm.dataFactoryDatasetCosmosdbSqlapi.DataFactoryDatasetCosmosdbSqlapiTimeoutsOutputReference",
