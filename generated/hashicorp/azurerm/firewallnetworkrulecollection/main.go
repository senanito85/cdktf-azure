...
func init() {
	_jsii_.RegisterClass(
		"azurerm.firewallNetworkRuleCollection.FirewallNetworkRuleCollection",
	...
	_jsii_.RegisterStruct(
		"azurerm.firewallNetworkRuleCollection.FirewallNetworkRuleCollectionConfig",
		reflect.TypeOf((*FirewallNetworkRuleCollectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.firewallNetworkRuleCollection.FirewallNetworkRuleCollectionRule",
		reflect.TypeOf((*FirewallNetworkRuleCollectionRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.firewallNetworkRuleCollection.FirewallNetworkRuleCollectionRuleList",
	...
	_jsii_.RegisterStruct(
		"azurerm.firewallNetworkRuleCollection.FirewallNetworkRuleCollectionTimeouts",
		reflect.TypeOf((*FirewallNetworkRuleCollectionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.firewallNetworkRuleCollection.FirewallNetworkRuleCollectionTimeoutsOutputReference",
