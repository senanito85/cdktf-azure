...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/purview_account azurerm_purview_account}.
type PurviewAccount interface {
	...
	Id() *string
	SetId(val *string)
	Identity() PurviewAccountIdentityList
	IdInput() *string
	// Experimental.
...
func (j *jsiiProxy_PurviewAccount) Identity() PurviewAccountIdentityList {
	var returns PurviewAccountIdentityList
	_jsii_.Get(
		j,
		"identity",
		&returns,
...
func (j *jsiiProxy_PurviewAccount) SkuName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"skuName",
...
func (j *jsiiProxy_PurviewAccount) SkuNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"skuNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/purview_account azurerm_purview_account} Resource.
...
func (j *jsiiProxy_PurviewAccount)SetSkuName(val *string) {
...
func (p *jsiiProxy_PurviewAccount) ResetSkuName() {
	_jsii_.InvokeVoid(
		p,
		"resetSkuName",
		nil, // no parameters
