...
func init() {
	_jsii_.RegisterClass(
		"azurerm.purviewAccount.PurviewAccount",
		reflect.TypeOf((*PurviewAccount)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "atlasKafkaEndpointPrimaryConnectionString", GoGetter: "AtlasKafkaEndpointPrimaryConnectionString"},
			_jsii_.MemberProperty{JsiiProperty: "atlasKafkaEndpointSecondaryConnectionString", GoGetter: "AtlasKafkaEndpointSecondaryConnectionString"},
			_jsii_.MemberProperty{JsiiProperty: "catalogEndpoint", GoGetter: "CatalogEndpoint"},
			...
			_jsii_.MemberProperty{JsiiProperty: "guardianEndpoint", GoGetter: "GuardianEndpoint"},
			...
			_jsii_.MemberProperty{JsiiProperty: "publicNetworkEnabled", GoGetter: "PublicNetworkEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "publicNetworkEnabledInput", GoGetter: "PublicNetworkEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPublicNetworkEnabled", GoMethod: "ResetPublicNetworkEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scanEndpoint", GoGetter: "ScanEndpoint"},
	...
	_jsii_.RegisterClass(
		"azurerm.purviewAccount.PurviewAccountIdentityOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.purviewAccount.PurviewAccountManagedResources",
		reflect.TypeOf((*PurviewAccountManagedResources)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.purviewAccount.PurviewAccountManagedResourcesList",
	...
	_jsii_.RegisterClass(
		"azurerm.purviewAccount.PurviewAccountManagedResourcesOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.purviewAccount.PurviewAccountTimeouts",
		reflect.TypeOf((*PurviewAccountTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.purviewAccount.PurviewAccountTimeoutsOutputReference",
