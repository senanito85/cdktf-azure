...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/signalr_service azurerm_signalr_service}.
type SignalrService interface {
	...
	Features() SignalrServiceFeaturesList
...
func (j *jsiiProxy_SignalrService) Features() SignalrServiceFeaturesList {
	var returns SignalrServiceFeaturesList
	_jsii_.Get(
		j,
		"features",
		&returns,
...
func (j *jsiiProxy_SignalrService) FeaturesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"featuresInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/signalr_service azurerm_signalr_service} Resource.
...
func (s *jsiiProxy_SignalrService) PutFeatures(value interface{}) {
...
func (s *jsiiProxy_SignalrService) ResetFeatures() {
	_jsii_.InvokeVoid(
		s,
		"resetFeatures",
		nil, // no parameters
