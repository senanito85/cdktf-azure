...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/datafactorylinkedserviceazureblobstorage/internal"
)
...
func NewDataFactoryLinkedServiceAzureBlobStorageTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryLinkedServiceAzureBlobStorageTimeoutsOutputReference {
	...
	if err := validateNewDataFactoryLinkedServiceAzureBlobStorageTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryLinkedServiceAzureBlobStorageTimeoutsOutputReference{}

	_jsii_.Create(
		"azurerm.dataFactoryLinkedServiceAzureBlobStorage.DataFactoryLinkedServiceAzureBlobStorageTimeoutsOutputReference",
