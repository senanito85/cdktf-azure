...
type VpnGatewayConnectionRoutingOutputReference interface {
	...
	SetPropagatedRouteTables(val *[]*string)
	PropagatedRouteTablesInput() *[]*string
	// Experimental.
...
func (j *jsiiProxy_VpnGatewayConnectionRoutingOutputReference) PropagatedRouteTables() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpnGatewayConnectionRoutingOutputReference) PropagatedRouteTablesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"propagatedRouteTablesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_VpnGatewayConnectionRoutingOutputReference)SetPropagatedRouteTables(val *[]*string) {
	if err := j.validateSetPropagatedRouteTablesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (v *jsiiProxy_VpnGatewayConnectionRoutingOutputReference) ResetPropagatedRouteTables() {
	_jsii_.InvokeVoid(
		v,
		"resetPropagatedRouteTables",
		nil, // no parameters
