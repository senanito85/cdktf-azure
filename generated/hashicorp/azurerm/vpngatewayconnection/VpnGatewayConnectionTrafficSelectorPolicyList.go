...
func NewVpnGatewayConnectionTrafficSelectorPolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnGatewayConnectionTrafficSelectorPolicyList {
	...
	if err := validateNewVpnGatewayConnectionTrafficSelectorPolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpnGatewayConnectionTrafficSelectorPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
