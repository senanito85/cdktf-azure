...
func NewLogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList {
	...
	if err := validateNewLogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList{}

	_jsii_.Create(
		"azurerm.logicAppWorkflow.LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList",
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
