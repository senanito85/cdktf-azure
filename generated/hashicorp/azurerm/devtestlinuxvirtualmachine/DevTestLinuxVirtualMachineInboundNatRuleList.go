...
func NewDevTestLinuxVirtualMachineInboundNatRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DevTestLinuxVirtualMachineInboundNatRuleList {
	...
	if err := validateNewDevTestLinuxVirtualMachineInboundNatRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
