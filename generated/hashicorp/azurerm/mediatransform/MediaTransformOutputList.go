...
func NewMediaTransformOutputList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaTransformOutputList {
	...
	if err := validateNewMediaTransformOutputListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MediaTransformOutputList{}

	_jsii_.Create(
		"azurerm.mediaTransform.MediaTransformOutputList",
...
func (m *jsiiProxy_MediaTransformOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
