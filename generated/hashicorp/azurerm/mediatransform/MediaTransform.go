...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/media_transform azurerm_media_transform}.
...
func (j *jsiiProxy_MediaTransform) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/media_transform azurerm_media_transform} Resource.
func NewMediaTransform(scope constructs.Construct, id *string, config *MediaTransformConfig) MediaTransform {
	_init_.Initialize()

	if err := validateNewMediaTransformParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_MediaTransform{}

	_jsii_.Create(
		"azurerm.mediaTransform.MediaTransform",
...
func (j *jsiiProxy_MediaTransform)SetCount(val interface{}) {
...
func MediaTransform_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMediaTransform_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MediaTransform_IsConstruct(x interface{}) *bool {
	...
	if err := validateMediaTransform_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MediaTransform_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateMediaTransform_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MediaTransform_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateMediaTransform_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MediaTransform) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MediaTransform) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MediaTransform) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MediaTransform) MoveFromId(id *string) {
...
func (m *jsiiProxy_MediaTransform) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MediaTransform) MoveToId(id *string) {
...
func (m *jsiiProxy_MediaTransform) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MediaTransform) ToHclTerraform() interface{} {
	var returns interface{}
