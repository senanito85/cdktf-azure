...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/availabilityset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/availability_set azurerm_availability_set}.
...
func (j *jsiiProxy_AvailabilitySet) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/availability_set azurerm_availability_set} Resource.
func NewAvailabilitySet(scope constructs.Construct, id *string, config *AvailabilitySetConfig) AvailabilitySet {
	_init_.Initialize()

	if err := validateNewAvailabilitySetParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_AvailabilitySet{}

	_jsii_.Create(
		"azurerm.availabilitySet.AvailabilitySet",
...
func (j *jsiiProxy_AvailabilitySet)SetCount(val interface{}) {
...
func (j *jsiiProxy_AvailabilitySet)SetPlatformUpdateDomainCount(val *float64) {
	if err := j.validateSetPlatformUpdateDomainCountParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func AvailabilitySet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAvailabilitySet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AvailabilitySet_IsConstruct(x interface{}) *bool {
	...
	if err := validateAvailabilitySet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AvailabilitySet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAvailabilitySet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AvailabilitySet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAvailabilitySet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AvailabilitySet) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AvailabilitySet) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AvailabilitySet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AvailabilitySet) MoveFromId(id *string) {
...
func (a *jsiiProxy_AvailabilitySet) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AvailabilitySet) MoveToId(id *string) {
...
func (a *jsiiProxy_AvailabilitySet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AvailabilitySet) ToHclTerraform() interface{} {
	var returns interface{}
