...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "platformUpdateDomainCountInput", GoGetter: "PlatformUpdateDomainCountInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPlatformUpdateDomainCount", GoMethod: "ResetPlatformUpdateDomainCount"},
	...
	_jsii_.RegisterStruct(
		"azurerm.availabilitySet.AvailabilitySetTimeouts",
		reflect.TypeOf((*AvailabilitySetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.availabilitySet.AvailabilitySetTimeoutsOutputReference",
