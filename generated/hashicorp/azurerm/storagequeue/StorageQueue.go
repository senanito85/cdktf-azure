...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/storagequeue/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/storage_queue azurerm_storage_queue}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/storage_queue azurerm_storage_queue} Resource.
func NewStorageQueue(scope constructs.Construct, id *string, config *StorageQueueConfig) StorageQueue {
	...
	_jsii_.Create(
		"azurerm.storageQueue.StorageQueue",
