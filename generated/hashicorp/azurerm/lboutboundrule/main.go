...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.lbOutboundRule.LbOutboundRuleConfig",
		reflect.TypeOf((*LbOutboundRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.lbOutboundRule.LbOutboundRuleFrontendIpConfiguration",
		reflect.TypeOf((*LbOutboundRuleFrontendIpConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.lbOutboundRule.LbOutboundRuleFrontendIpConfigurationList",
	...
	_jsii_.RegisterClass(
		"azurerm.lbOutboundRule.LbOutboundRuleFrontendIpConfigurationOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.lbOutboundRule.LbOutboundRuleTimeouts",
		reflect.TypeOf((*LbOutboundRuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.lbOutboundRule.LbOutboundRuleTimeoutsOutputReference",
