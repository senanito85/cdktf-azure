...
func NewSynapseWorkspaceIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SynapseWorkspaceIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewSynapseWorkspaceIdentityOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_SynapseWorkspaceIdentityOutputReference{}

	_jsii_.Create(
		"azurerm.synapseWorkspace.SynapseWorkspaceIdentityOutputReference",
...
func NewSynapseWorkspaceIdentityOutputReference_Override(s SynapseWorkspaceIdentityOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
