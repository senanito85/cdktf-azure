...
func NewSynapseWorkspaceSqlAadAdminList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SynapseWorkspaceSqlAadAdminList {
	...
	if err := validateNewSynapseWorkspaceSqlAadAdminListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_SynapseWorkspaceSqlAadAdminList{}

	_jsii_.Create(
		"azurerm.synapseWorkspace.SynapseWorkspaceSqlAadAdminList",
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
