...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/app_service_slot azurerm_app_service_slot}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/app_service_slot azurerm_app_service_slot} Resource.
...
func AppServiceSlot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppServiceSlot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppServiceSlot) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppServiceSlot) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AppServiceSlot) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppServiceSlot) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppServiceSlot) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AppServiceSlot) MoveToId(id *string) {
...
func (a *jsiiProxy_AppServiceSlot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AppServiceSlot) ToHclTerraform() interface{} {
	var returns interface{}
