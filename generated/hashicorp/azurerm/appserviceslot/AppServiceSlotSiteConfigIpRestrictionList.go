...
func NewAppServiceSlotSiteConfigIpRestrictionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppServiceSlotSiteConfigIpRestrictionList {
	...
	if err := validateNewAppServiceSlotSiteConfigIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppServiceSlotSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
