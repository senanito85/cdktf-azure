...
func init() {
	_jsii_.RegisterClass(
		"azurerm.virtualNetworkDnsServers.VirtualNetworkDnsServers",
	...
	_jsii_.RegisterStruct(
		"azurerm.virtualNetworkDnsServers.VirtualNetworkDnsServersConfig",
		reflect.TypeOf((*VirtualNetworkDnsServersConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.virtualNetworkDnsServers.VirtualNetworkDnsServersTimeouts",
		reflect.TypeOf((*VirtualNetworkDnsServersTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.virtualNetworkDnsServers.VirtualNetworkDnsServersTimeoutsOutputReference",
