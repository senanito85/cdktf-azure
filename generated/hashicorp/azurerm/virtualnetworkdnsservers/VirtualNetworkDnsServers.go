...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/virtual_network_dns_servers azurerm_virtual_network_dns_servers}.
...
func (j *jsiiProxy_VirtualNetworkDnsServers) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_VirtualNetworkDnsServers) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_VirtualNetworkDnsServers) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualNetworkDnsServers) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_VirtualNetworkDnsServers) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/virtual_network_dns_servers azurerm_virtual_network_dns_servers} Resource.
...
func (j *jsiiProxy_VirtualNetworkDnsServers)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualNetworkDnsServers)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualNetworkDnsServers)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualNetworkDnsServers_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VirtualNetworkDnsServers) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkDnsServers) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VirtualNetworkDnsServers) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
