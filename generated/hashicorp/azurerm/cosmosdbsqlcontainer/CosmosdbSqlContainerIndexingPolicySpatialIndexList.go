...
func NewCosmosdbSqlContainerIndexingPolicySpatialIndexList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbSqlContainerIndexingPolicySpatialIndexList {
	...
	if err := validateNewCosmosdbSqlContainerIndexingPolicySpatialIndexListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicySpatialIndexList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
