...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/iothub_endpoint_servicebus_queue azurerm_iothub_endpoint_servicebus_queue}.
...
func (j *jsiiProxy_IothubEndpointServicebusQueue) IothubName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"iothubName",
...
func (j *jsiiProxy_IothubEndpointServicebusQueue) IothubNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"iothubNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/iothub_endpoint_servicebus_queue azurerm_iothub_endpoint_servicebus_queue} Resource.
func NewIothubEndpointServicebusQueue(scope constructs.Construct, id *string, config *IothubEndpointServicebusQueueConfig) IothubEndpointServicebusQueue {
	...
	_jsii_.Create(
		"azurerm.iothubEndpointServicebusQueue.IothubEndpointServicebusQueue",
...
func (j *jsiiProxy_IothubEndpointServicebusQueue)SetIothubName(val *string) {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) ResetIothubId() {
	_jsii_.InvokeVoid(
		i,
		"resetIothubId",
		nil, // no parameters
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) ResetIothubName() {
	_jsii_.InvokeVoid(
		i,
		"resetIothubName",
		nil, // no parameters
