...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/iothubendpointservicebusqueue/internal"
)
...
func NewIothubEndpointServicebusQueueTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IothubEndpointServicebusQueueTimeoutsOutputReference {
	...
	if err := validateNewIothubEndpointServicebusQueueTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
