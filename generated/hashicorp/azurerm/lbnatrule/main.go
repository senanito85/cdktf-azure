...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbNatRule)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "backendIpConfigurationId", GoGetter: "BackendIpConfigurationId"},
	...
	_jsii_.RegisterStruct(
		"azurerm.lbNatRule.LbNatRuleConfig",
		reflect.TypeOf((*LbNatRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.lbNatRule.LbNatRuleTimeouts",
		reflect.TypeOf((*LbNatRuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.lbNatRule.LbNatRuleTimeoutsOutputReference",
		reflect.TypeOf((*LbNatRuleTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
