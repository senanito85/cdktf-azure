...
func NewConsumptionBudgetManagementGroupFilterDimensionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetManagementGroupFilterDimensionList {
	...
	if err := validateNewConsumptionBudgetManagementGroupFilterDimensionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ConsumptionBudgetManagementGroupFilterDimensionList{}

	_jsii_.Create(
		"azurerm.consumptionBudgetManagementGroup.ConsumptionBudgetManagementGroupFilterDimensionList",
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
