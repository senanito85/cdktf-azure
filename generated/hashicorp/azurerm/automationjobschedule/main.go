...
func init() {
	_jsii_.RegisterClass(
		"azurerm.automationJobSchedule.AutomationJobSchedule",
	...
	_jsii_.RegisterStruct(
		"azurerm.automationJobSchedule.AutomationJobScheduleConfig",
		reflect.TypeOf((*AutomationJobScheduleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.automationJobSchedule.AutomationJobScheduleTimeouts",
		reflect.TypeOf((*AutomationJobScheduleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.automationJobSchedule.AutomationJobScheduleTimeoutsOutputReference",
