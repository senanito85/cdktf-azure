...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermUserAssignedIdentity.DataAzurermUserAssignedIdentity",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermUserAssignedIdentity.DataAzurermUserAssignedIdentityConfig",
		reflect.TypeOf((*DataAzurermUserAssignedIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermUserAssignedIdentity.DataAzurermUserAssignedIdentityTimeouts",
