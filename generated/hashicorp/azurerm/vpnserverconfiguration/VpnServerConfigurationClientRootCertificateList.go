...
func NewVpnServerConfigurationClientRootCertificateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnServerConfigurationClientRootCertificateList {
	...
	_jsii_.Create(
		"azurerm.vpnServerConfiguration.VpnServerConfigurationClientRootCertificateList",
...
func (v *jsiiProxy_VpnServerConfigurationClientRootCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
