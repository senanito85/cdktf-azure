...
func NewVpnServerConfigurationRadiusServerList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnServerConfigurationRadiusServerList {
	...
	if err := validateNewVpnServerConfigurationRadiusServerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_VpnServerConfigurationRadiusServerList{}

	_jsii_.Create(
		"azurerm.vpnServerConfiguration.VpnServerConfigurationRadiusServerList",
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
