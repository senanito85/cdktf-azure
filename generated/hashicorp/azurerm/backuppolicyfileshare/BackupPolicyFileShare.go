...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/backup_policy_file_share azurerm_backup_policy_file_share}.
...
func (j *jsiiProxy_BackupPolicyFileShare) Tags() *map[string]*string {
...
func (j *jsiiProxy_BackupPolicyFileShare) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/backup_policy_file_share azurerm_backup_policy_file_share} Resource.
func NewBackupPolicyFileShare(scope constructs.Construct, id *string, config *BackupPolicyFileShareConfig) BackupPolicyFileShare {
	...
	_jsii_.Create(
		"azurerm.backupPolicyFileShare.BackupPolicyFileShare",
...
func (j *jsiiProxy_BackupPolicyFileShare)SetTags(val *map[string]*string) {
...
func (b *jsiiProxy_BackupPolicyFileShare) ResetTags() {
	_jsii_.InvokeVoid(
		b,
		"resetTags",
		nil, // no parameters
