...
func (k *jsiiProxy_KubernetesCluster) validatePutAddonProfileParameters(value *KubernetesClusterAddonProfile) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (k *jsiiProxy_KubernetesCluster) validatePutRoleBasedAccessControlParameters(value *KubernetesClusterRoleBasedAccessControl) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_KubernetesCluster) validateSetPrivateLinkEnabledParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
