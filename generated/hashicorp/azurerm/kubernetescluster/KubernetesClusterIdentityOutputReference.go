...
func (j *jsiiProxy_KubernetesClusterIdentityOutputReference) UserAssignedIdentityId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KubernetesClusterIdentityOutputReference) UserAssignedIdentityIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KubernetesClusterIdentityOutputReference)SetUserAssignedIdentityId(val *string) {
...
func (k *jsiiProxy_KubernetesClusterIdentityOutputReference) ResetUserAssignedIdentityId() {
	_jsii_.InvokeVoid(
		k,
		"resetUserAssignedIdentityId",
		nil, // no parameters
