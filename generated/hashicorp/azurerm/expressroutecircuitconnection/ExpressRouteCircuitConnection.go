...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/expressroutecircuitconnection/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/express_route_circuit_connection azurerm_express_route_circuit_connection}.
...
func (j *jsiiProxy_ExpressRouteCircuitConnection) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/express_route_circuit_connection azurerm_express_route_circuit_connection} Resource.
func NewExpressRouteCircuitConnection(scope constructs.Construct, id *string, config *ExpressRouteCircuitConnectionConfig) ExpressRouteCircuitConnection {
	...
	if err := validateNewExpressRouteCircuitConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ExpressRouteCircuitConnection)SetAddressPrefixIpv4(val *string) {
	if err := j.validateSetAddressPrefixIpv4Parameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ExpressRouteCircuitConnection)SetAddressPrefixIpv6(val *string) {
	if err := j.validateSetAddressPrefixIpv6Parameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ExpressRouteCircuitConnection)SetCount(val interface{}) {
...
func (j *jsiiProxy_ExpressRouteCircuitConnection)SetPeerPeeringId(val *string) {
	if err := j.validateSetPeerPeeringIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func ExpressRouteCircuitConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateExpressRouteCircuitConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ExpressRouteCircuitConnection_IsConstruct(x interface{}) *bool {
	...
	if err := validateExpressRouteCircuitConnection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ExpressRouteCircuitConnection_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateExpressRouteCircuitConnection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ExpressRouteCircuitConnection_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateExpressRouteCircuitConnection_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_ExpressRouteCircuitConnection) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ExpressRouteCircuitConnection) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_ExpressRouteCircuitConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_ExpressRouteCircuitConnection) MoveFromId(id *string) {
...
func (e *jsiiProxy_ExpressRouteCircuitConnection) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_ExpressRouteCircuitConnection) MoveToId(id *string) {
...
func (e *jsiiProxy_ExpressRouteCircuitConnection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_ExpressRouteCircuitConnection) ToHclTerraform() interface{} {
	var returns interface{}
