...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/log_analytics_linked_service azurerm_log_analytics_linked_service}.
...
func (j *jsiiProxy_LogAnalyticsLinkedService) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LogAnalyticsLinkedService) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LogAnalyticsLinkedService) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogAnalyticsLinkedService) LinkedServiceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"linkedServiceName",
...
func (j *jsiiProxy_LogAnalyticsLinkedService) LinkedServiceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LogAnalyticsLinkedService) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_LogAnalyticsLinkedService) ResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceId",
...
func (j *jsiiProxy_LogAnalyticsLinkedService) ResourceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceIdInput",
...
func (j *jsiiProxy_LogAnalyticsLinkedService) Tags() *map[string]*string {
...
func (j *jsiiProxy_LogAnalyticsLinkedService) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_LogAnalyticsLinkedService) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LogAnalyticsLinkedService) WorkspaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspaceName",
...
func (j *jsiiProxy_LogAnalyticsLinkedService) WorkspaceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspaceNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/log_analytics_linked_service azurerm_log_analytics_linked_service} Resource.
func NewLogAnalyticsLinkedService(scope constructs.Construct, id *string, config *LogAnalyticsLinkedServiceConfig) LogAnalyticsLinkedService {
	...
	_jsii_.Create(
		"azurerm.logAnalyticsLinkedService.LogAnalyticsLinkedService",
...
func (j *jsiiProxy_LogAnalyticsLinkedService)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogAnalyticsLinkedService)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogAnalyticsLinkedService)SetLinkedServiceName(val *string) {
...
func (j *jsiiProxy_LogAnalyticsLinkedService)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LogAnalyticsLinkedService)SetResourceId(val *string) {
...
func (j *jsiiProxy_LogAnalyticsLinkedService)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_LogAnalyticsLinkedService)SetWorkspaceName(val *string) {
...
func LogAnalyticsLinkedService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LogAnalyticsLinkedService) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsLinkedService) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsLinkedService) ResetLinkedServiceName() {
	_jsii_.InvokeVoid(
		l,
		"resetLinkedServiceName",
		nil, // no parameters
...
func (l *jsiiProxy_LogAnalyticsLinkedService) ResetResourceId() {
	_jsii_.InvokeVoid(
		l,
		"resetResourceId",
		nil, // no parameters
...
func (l *jsiiProxy_LogAnalyticsLinkedService) ResetTags() {
	_jsii_.InvokeVoid(
		l,
		"resetTags",
		nil, // no parameters
...
func (l *jsiiProxy_LogAnalyticsLinkedService) ResetWorkspaceId() {
	_jsii_.InvokeVoid(
		l,
		"resetWorkspaceId",
		nil, // no parameters
...
func (l *jsiiProxy_LogAnalyticsLinkedService) ResetWorkspaceName() {
	_jsii_.InvokeVoid(
		l,
		"resetWorkspaceName",
		nil, // no parameters
