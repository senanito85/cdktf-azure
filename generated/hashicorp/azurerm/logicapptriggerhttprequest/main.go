...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogicAppTriggerHttpRequest)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.logicAppTriggerHttpRequest.LogicAppTriggerHttpRequestConfig",
		reflect.TypeOf((*LogicAppTriggerHttpRequestConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.logicAppTriggerHttpRequest.LogicAppTriggerHttpRequestTimeouts",
		reflect.TypeOf((*LogicAppTriggerHttpRequestTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.logicAppTriggerHttpRequest.LogicAppTriggerHttpRequestTimeoutsOutputReference",
		reflect.TypeOf((*LogicAppTriggerHttpRequestTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
