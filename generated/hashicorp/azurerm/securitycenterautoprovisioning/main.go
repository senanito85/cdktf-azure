...
func init() {
	_jsii_.RegisterClass(
		"azurerm.securityCenterAutoProvisioning.SecurityCenterAutoProvisioning",
	...
	_jsii_.RegisterStruct(
		"azurerm.securityCenterAutoProvisioning.SecurityCenterAutoProvisioningConfig",
		reflect.TypeOf((*SecurityCenterAutoProvisioningConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.securityCenterAutoProvisioning.SecurityCenterAutoProvisioningTimeouts",
