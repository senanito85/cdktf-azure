...
func NewManagementGroupPolicyAssignmentNonComplianceMessageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ManagementGroupPolicyAssignmentNonComplianceMessageList {
	...
	_jsii_.Create(
		"azurerm.managementGroupPolicyAssignment.ManagementGroupPolicyAssignmentNonComplianceMessageList",
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
