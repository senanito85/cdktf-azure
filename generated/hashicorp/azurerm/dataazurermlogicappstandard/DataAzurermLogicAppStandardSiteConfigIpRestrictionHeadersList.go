...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteConfigIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
