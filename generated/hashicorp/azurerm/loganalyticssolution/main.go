...
func init() {
	_jsii_.RegisterClass(
		"azurerm.logAnalyticsSolution.LogAnalyticsSolution",
	...
	_jsii_.RegisterStruct(
		"azurerm.logAnalyticsSolution.LogAnalyticsSolutionConfig",
		reflect.TypeOf((*LogAnalyticsSolutionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.logAnalyticsSolution.LogAnalyticsSolutionPlan",
		reflect.TypeOf((*LogAnalyticsSolutionPlan)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.logAnalyticsSolution.LogAnalyticsSolutionPlanOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.logAnalyticsSolution.LogAnalyticsSolutionTimeouts",
		reflect.TypeOf((*LogAnalyticsSolutionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.logAnalyticsSolution.LogAnalyticsSolutionTimeoutsOutputReference",
