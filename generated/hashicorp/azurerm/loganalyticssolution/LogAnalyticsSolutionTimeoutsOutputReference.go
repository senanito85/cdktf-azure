...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/loganalyticssolution/internal"
)
...
func NewLogAnalyticsSolutionTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LogAnalyticsSolutionTimeoutsOutputReference {
	...
	if err := validateNewLogAnalyticsSolutionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
