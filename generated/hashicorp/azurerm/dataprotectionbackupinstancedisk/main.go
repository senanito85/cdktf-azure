...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataProtectionBackupInstanceDisk.DataProtectionBackupInstanceDiskConfig",
		reflect.TypeOf((*DataProtectionBackupInstanceDiskConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataProtectionBackupInstanceDisk.DataProtectionBackupInstanceDiskTimeouts",
