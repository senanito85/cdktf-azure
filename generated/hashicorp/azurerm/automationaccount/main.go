...
func init() {
	_jsii_.RegisterClass(
		"azurerm.automationAccount.AutomationAccount",
	...
	_jsii_.RegisterStruct(
		"azurerm.automationAccount.AutomationAccountConfig",
		reflect.TypeOf((*AutomationAccountConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.automationAccount.AutomationAccountIdentity",
		reflect.TypeOf((*AutomationAccountIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.automationAccount.AutomationAccountIdentityOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.automationAccount.AutomationAccountTimeouts",
		reflect.TypeOf((*AutomationAccountTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.automationAccount.AutomationAccountTimeoutsOutputReference",
