...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermVirtualHub.DataAzurermVirtualHubConfig",
		reflect.TypeOf((*DataAzurermVirtualHubConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermVirtualHub.DataAzurermVirtualHubTimeouts",
		reflect.TypeOf((*DataAzurermVirtualHubTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermVirtualHub.DataAzurermVirtualHubTimeoutsOutputReference",
