...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/backupprotectedvm/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/backup_protected_vm azurerm_backup_protected_vm}.
...
func (j *jsiiProxy_BackupProtectedVm) Tags() *map[string]*string {
...
func (j *jsiiProxy_BackupProtectedVm) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/backup_protected_vm azurerm_backup_protected_vm} Resource.
...
func (j *jsiiProxy_BackupProtectedVm)SetTags(val *map[string]*string) {
...
func (b *jsiiProxy_BackupProtectedVm) ResetTags() {
	_jsii_.InvokeVoid(
		b,
		"resetTags",
		nil, // no parameters
