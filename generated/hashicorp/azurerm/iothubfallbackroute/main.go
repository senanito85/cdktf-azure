...
func init() {
	_jsii_.RegisterClass(
		"azurerm.iothubFallbackRoute.IothubFallbackRouteA",
	...
	_jsii_.RegisterStruct(
		"azurerm.iothubFallbackRoute.IothubFallbackRouteAConfig",
		reflect.TypeOf((*IothubFallbackRouteAConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.iothubFallbackRoute.IothubFallbackRouteTimeouts",
		reflect.TypeOf((*IothubFallbackRouteTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.iothubFallbackRoute.IothubFallbackRouteTimeoutsOutputReference",
