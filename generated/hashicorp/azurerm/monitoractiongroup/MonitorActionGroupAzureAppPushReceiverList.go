...
func NewMonitorActionGroupAzureAppPushReceiverList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupAzureAppPushReceiverList {
	...
	if err := validateNewMonitorActionGroupAzureAppPushReceiverListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorActionGroupAzureAppPushReceiverList{}

	_jsii_.Create(
		"azurerm.monitorActionGroup.MonitorActionGroupAzureAppPushReceiverList",
...
func (m *jsiiProxy_MonitorActionGroupAzureAppPushReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
