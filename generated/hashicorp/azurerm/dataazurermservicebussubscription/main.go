...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermServicebusSubscription.DataAzurermServicebusSubscription",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermServicebusSubscription.DataAzurermServicebusSubscriptionTimeouts",
