...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.virtualHub.VirtualHubConfig",
		reflect.TypeOf((*VirtualHubConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.virtualHub.VirtualHubRoute",
		reflect.TypeOf((*VirtualHubRoute)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.virtualHub.VirtualHubRouteList",
	...
	_jsii_.RegisterClass(
		"azurerm.virtualHub.VirtualHubRouteOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.virtualHub.VirtualHubTimeouts",
		reflect.TypeOf((*VirtualHubTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.virtualHub.VirtualHubTimeoutsOutputReference",
