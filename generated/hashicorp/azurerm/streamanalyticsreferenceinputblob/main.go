...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobConfig",
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlobConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobSerialization",
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlobSerialization)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobSerializationOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobTimeouts",
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlobTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobTimeoutsOutputReference",
