...
func init() {
	_jsii_.RegisterClass(
		"azurerm.apiManagementNotificationRecipientUser.ApiManagementNotificationRecipientUser",
	...
	_jsii_.RegisterStruct(
		"azurerm.apiManagementNotificationRecipientUser.ApiManagementNotificationRecipientUserConfig",
		reflect.TypeOf((*ApiManagementNotificationRecipientUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.apiManagementNotificationRecipientUser.ApiManagementNotificationRecipientUserTimeouts",
