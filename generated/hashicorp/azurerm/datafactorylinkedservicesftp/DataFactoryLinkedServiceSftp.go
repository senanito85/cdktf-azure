...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/datafactorylinkedservicesftp/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_linked_service_sftp azurerm_data_factory_linked_service_sftp}.
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftp) DataFactoryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataFactoryName",
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftp) DataFactoryNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftp) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftp) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_linked_service_sftp azurerm_data_factory_linked_service_sftp} Resource.
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftp)SetDataFactoryName(val *string) {
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftp)SetResourceGroupName(val *string) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSftp) ResetDataFactoryId() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryId",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryLinkedServiceSftp) ResetDataFactoryName() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryName",
		nil, // no parameters
