...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/mysqlflexibleserverfirewallrule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/mysql_flexible_server_firewall_rule azurerm_mysql_flexible_server_firewall_rule}.
...
func (j *jsiiProxy_MysqlFlexibleServerFirewallRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/mysql_flexible_server_firewall_rule azurerm_mysql_flexible_server_firewall_rule} Resource.
func NewMysqlFlexibleServerFirewallRule(scope constructs.Construct, id *string, config *MysqlFlexibleServerFirewallRuleConfig) MysqlFlexibleServerFirewallRule {
	...
	if err := validateNewMysqlFlexibleServerFirewallRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MysqlFlexibleServerFirewallRule)SetCount(val interface{}) {
...
func MysqlFlexibleServerFirewallRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMysqlFlexibleServerFirewallRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MysqlFlexibleServerFirewallRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateMysqlFlexibleServerFirewallRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MysqlFlexibleServerFirewallRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMysqlFlexibleServerFirewallRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MysqlFlexibleServerFirewallRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMysqlFlexibleServerFirewallRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MysqlFlexibleServerFirewallRule) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MysqlFlexibleServerFirewallRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MysqlFlexibleServerFirewallRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MysqlFlexibleServerFirewallRule) MoveFromId(id *string) {
...
func (m *jsiiProxy_MysqlFlexibleServerFirewallRule) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MysqlFlexibleServerFirewallRule) MoveToId(id *string) {
...
func (m *jsiiProxy_MysqlFlexibleServerFirewallRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MysqlFlexibleServerFirewallRule) ToHclTerraform() interface{} {
	var returns interface{}
