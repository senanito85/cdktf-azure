...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkInterfaceNatRuleAssociation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "natRuleId", GoGetter: "NatRuleId"},
			_jsii_.MemberProperty{JsiiProperty: "natRuleIdInput", GoGetter: "NatRuleIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkInterfaceNatRuleAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.networkInterfaceNatRuleAssociation.NetworkInterfaceNatRuleAssociationTimeouts",
		reflect.TypeOf((*NetworkInterfaceNatRuleAssociationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.networkInterfaceNatRuleAssociation.NetworkInterfaceNatRuleAssociationTimeoutsOutputReference",
		reflect.TypeOf((*NetworkInterfaceNatRuleAssociationTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
