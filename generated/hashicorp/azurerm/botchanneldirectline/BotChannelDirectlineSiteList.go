...
func NewBotChannelDirectlineSiteList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BotChannelDirectlineSiteList {
	...
	if err := validateNewBotChannelDirectlineSiteListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BotChannelDirectlineSiteList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
