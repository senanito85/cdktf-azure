...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/storage_management_policy azurerm_storage_management_policy}.
...
func (j *jsiiProxy_StorageManagementPolicy) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/storage_management_policy azurerm_storage_management_policy} Resource.
func NewStorageManagementPolicy(scope constructs.Construct, id *string, config *StorageManagementPolicyConfig) StorageManagementPolicy {
	...
	if err := validateNewStorageManagementPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StorageManagementPolicy)SetCount(val interface{}) {
...
func StorageManagementPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStorageManagementPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func StorageManagementPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateStorageManagementPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func StorageManagementPolicy_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateStorageManagementPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func StorageManagementPolicy_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateStorageManagementPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StorageManagementPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageManagementPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageManagementPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StorageManagementPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageManagementPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StorageManagementPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageManagementPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StorageManagementPolicy) ToHclTerraform() interface{} {
	var returns interface{}
