...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/kusto_cluster_principal_assignment azurerm_kusto_cluster_principal_assignment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/kusto_cluster_principal_assignment azurerm_kusto_cluster_principal_assignment} Resource.
...
func KustoClusterPrincipalAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateKustoClusterPrincipalAssignment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) HasResourceMove() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) MoveFromId(id *string) {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) MoveTo(moveTarget *string, index interface{}) {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) MoveToId(id *string) {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) ToHclTerraform() interface{} {
	var returns interface{}
