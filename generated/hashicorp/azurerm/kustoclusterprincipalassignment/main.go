...
func init() {
	_jsii_.RegisterClass(
		"azurerm.kustoClusterPrincipalAssignment.KustoClusterPrincipalAssignment",
		reflect.TypeOf((*KustoClusterPrincipalAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.kustoClusterPrincipalAssignment.KustoClusterPrincipalAssignmentConfig",
		reflect.TypeOf((*KustoClusterPrincipalAssignmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.kustoClusterPrincipalAssignment.KustoClusterPrincipalAssignmentTimeouts",
		reflect.TypeOf((*KustoClusterPrincipalAssignmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.kustoClusterPrincipalAssignment.KustoClusterPrincipalAssignmentTimeoutsOutputReference",
		reflect.TypeOf((*KustoClusterPrincipalAssignmentTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
