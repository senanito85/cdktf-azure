...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.expressRouteConnection.ExpressRouteConnectionConfig",
		reflect.TypeOf((*ExpressRouteConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.expressRouteConnection.ExpressRouteConnectionRouting",
		reflect.TypeOf((*ExpressRouteConnectionRouting)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.expressRouteConnection.ExpressRouteConnectionRoutingOutputReference",
	...
	_jsii_.RegisterClass(
		"azurerm.expressRouteConnection.ExpressRouteConnectionTimeoutsOutputReference",
