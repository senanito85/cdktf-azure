...
func NewApiManagementApiOperationRequestRepresentationFormParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestRepresentationFormParameterList {
	...
	if err := validateNewApiManagementApiOperationRequestRepresentationFormParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationFormParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
