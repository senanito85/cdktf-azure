...
func NewApiManagementApiOperationResponseList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationResponseList {
	...
	if err := validateNewApiManagementApiOperationResponseListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiOperationResponseList{}

	_jsii_.Create(
		"azurerm.apiManagementApiOperation.ApiManagementApiOperationResponseList",
...
func (a *jsiiProxy_ApiManagementApiOperationResponseList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
