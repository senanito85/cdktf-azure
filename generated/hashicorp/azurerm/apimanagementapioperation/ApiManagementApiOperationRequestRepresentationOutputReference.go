...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference) Sample() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sample",
...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference) SampleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sampleInput",
...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference)SetSample(val *string) {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference) ResetSample() {
	_jsii_.InvokeVoid(
		a,
		"resetSample",
		nil, // no parameters
