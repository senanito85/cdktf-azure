...
func NewApiManagementApiOperationRequestRepresentationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestRepresentationList {
	...
	if err := validateNewApiManagementApiOperationRequestRepresentationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
