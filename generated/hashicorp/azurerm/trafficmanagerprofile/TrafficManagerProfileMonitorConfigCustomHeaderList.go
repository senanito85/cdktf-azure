...
func NewTrafficManagerProfileMonitorConfigCustomHeaderList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TrafficManagerProfileMonitorConfigCustomHeaderList {
	...
	if err := validateNewTrafficManagerProfileMonitorConfigCustomHeaderListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_TrafficManagerProfileMonitorConfigCustomHeaderList{}

	_jsii_.Create(
		"azurerm.trafficManagerProfile.TrafficManagerProfileMonitorConfigCustomHeaderList",
...
func (t *jsiiProxy_TrafficManagerProfileMonitorConfigCustomHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
