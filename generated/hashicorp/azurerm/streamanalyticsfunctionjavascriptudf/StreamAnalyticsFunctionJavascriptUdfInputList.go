...
func NewStreamAnalyticsFunctionJavascriptUdfInputList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StreamAnalyticsFunctionJavascriptUdfInputList {
	...
	if err := validateNewStreamAnalyticsFunctionJavascriptUdfInputListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
