...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataFactoryLinkedServiceDataLakeStorageGen2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.dataFactoryLinkedServiceDataLakeStorageGen2.DataFactoryLinkedServiceDataLakeStorageGen2Config",
		reflect.TypeOf((*DataFactoryLinkedServiceDataLakeStorageGen2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataFactoryLinkedServiceDataLakeStorageGen2.DataFactoryLinkedServiceDataLakeStorageGen2Timeouts",
		reflect.TypeOf((*DataFactoryLinkedServiceDataLakeStorageGen2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataFactoryLinkedServiceDataLakeStorageGen2.DataFactoryLinkedServiceDataLakeStorageGen2TimeoutsOutputReference",
		reflect.TypeOf((*DataFactoryLinkedServiceDataLakeStorageGen2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
