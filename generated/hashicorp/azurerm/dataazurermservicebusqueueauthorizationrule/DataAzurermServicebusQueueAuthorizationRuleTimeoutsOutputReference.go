...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/dataazurermservicebusqueueauthorizationrule/internal"
)
...
func NewDataAzurermServicebusQueueAuthorizationRuleTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermServicebusQueueAuthorizationRuleTimeoutsOutputReference {
	...
	if err := validateNewDataAzurermServicebusQueueAuthorizationRuleTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermServicebusQueueAuthorizationRuleTimeoutsOutputReference{}

	_jsii_.Create(
		"azurerm.dataAzurermServicebusQueueAuthorizationRule.DataAzurermServicebusQueueAuthorizationRuleTimeoutsOutputReference",
