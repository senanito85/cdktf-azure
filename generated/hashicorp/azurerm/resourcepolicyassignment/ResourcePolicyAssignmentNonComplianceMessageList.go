...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/resourcepolicyassignment/internal"
)
...
func NewResourcePolicyAssignmentNonComplianceMessageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResourcePolicyAssignmentNonComplianceMessageList {
	...
	if err := validateNewResourcePolicyAssignmentNonComplianceMessageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
