...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermEventhub.DataAzurermEventhub",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermEventhub.DataAzurermEventhubConfig",
		reflect.TypeOf((*DataAzurermEventhubConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermEventhub.DataAzurermEventhubTimeouts",
		reflect.TypeOf((*DataAzurermEventhubTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermEventhub.DataAzurermEventhubTimeoutsOutputReference",
