...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PostgresqlFlexibleServerDatabase)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.postgresqlFlexibleServerDatabase.PostgresqlFlexibleServerDatabaseConfig",
		reflect.TypeOf((*PostgresqlFlexibleServerDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.postgresqlFlexibleServerDatabase.PostgresqlFlexibleServerDatabaseTimeouts",
		reflect.TypeOf((*PostgresqlFlexibleServerDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.postgresqlFlexibleServerDatabase.PostgresqlFlexibleServerDatabaseTimeoutsOutputReference",
		reflect.TypeOf((*PostgresqlFlexibleServerDatabaseTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
