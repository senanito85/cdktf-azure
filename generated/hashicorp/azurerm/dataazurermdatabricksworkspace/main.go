...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermDatabricksWorkspace.DataAzurermDatabricksWorkspace",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermDatabricksWorkspace.DataAzurermDatabricksWorkspaceConfig",
		reflect.TypeOf((*DataAzurermDatabricksWorkspaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermDatabricksWorkspace.DataAzurermDatabricksWorkspaceTimeouts",
