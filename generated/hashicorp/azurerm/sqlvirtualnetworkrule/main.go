...
func init() {
	_jsii_.RegisterClass(
		"azurerm.sqlVirtualNetworkRule.SqlVirtualNetworkRule",
		reflect.TypeOf((*SqlVirtualNetworkRule)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SqlVirtualNetworkRule{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"azurerm.sqlVirtualNetworkRule.SqlVirtualNetworkRuleConfig",
		reflect.TypeOf((*SqlVirtualNetworkRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.sqlVirtualNetworkRule.SqlVirtualNetworkRuleTimeouts",
		reflect.TypeOf((*SqlVirtualNetworkRuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.sqlVirtualNetworkRule.SqlVirtualNetworkRuleTimeoutsOutputReference",
		reflect.TypeOf((*SqlVirtualNetworkRuleTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
