...
func NewConsumptionBudgetResourceGroupNotificationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetResourceGroupNotificationList {
	...
	_jsii_.Create(
		"azurerm.consumptionBudgetResourceGroup.ConsumptionBudgetResourceGroupNotificationList",
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
