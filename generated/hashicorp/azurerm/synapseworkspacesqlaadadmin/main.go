...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.synapseWorkspaceSqlAadAdmin.SynapseWorkspaceSqlAadAdminAConfig",
		reflect.TypeOf((*SynapseWorkspaceSqlAadAdminAConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.synapseWorkspaceSqlAadAdmin.SynapseWorkspaceSqlAadAdminTimeouts",
		reflect.TypeOf((*SynapseWorkspaceSqlAadAdminTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.synapseWorkspaceSqlAadAdmin.SynapseWorkspaceSqlAadAdminTimeoutsOutputReference",
