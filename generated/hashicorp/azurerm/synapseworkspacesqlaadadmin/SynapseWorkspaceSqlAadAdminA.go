...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/synapseworkspacesqlaadadmin/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/synapse_workspace_sql_aad_admin azurerm_synapse_workspace_sql_aad_admin}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/synapse_workspace_sql_aad_admin azurerm_synapse_workspace_sql_aad_admin} Resource.
...
func SynapseWorkspaceSqlAadAdminA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSynapseWorkspaceSqlAadAdminA_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminA) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminA) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminA) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminA) MoveFromId(id *string) {
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminA) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminA) MoveToId(id *string) {
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminA) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SynapseWorkspaceSqlAadAdminA) ToHclTerraform() interface{} {
	var returns interface{}
