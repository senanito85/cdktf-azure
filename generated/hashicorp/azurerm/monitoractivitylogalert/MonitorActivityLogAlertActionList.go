...
func NewMonitorActivityLogAlertActionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActivityLogAlertActionList {
	...
	_jsii_.Create(
		"azurerm.monitorActivityLogAlert.MonitorActivityLogAlertActionList",
...
func (m *jsiiProxy_MonitorActivityLogAlertActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
