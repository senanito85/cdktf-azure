...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/iothub_endpoint_eventhub azurerm_iothub_endpoint_eventhub}.
...
func (j *jsiiProxy_IothubEndpointEventhub) IothubName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"iothubName",
...
func (j *jsiiProxy_IothubEndpointEventhub) IothubNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"iothubNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/iothub_endpoint_eventhub azurerm_iothub_endpoint_eventhub} Resource.
func NewIothubEndpointEventhub(scope constructs.Construct, id *string, config *IothubEndpointEventhubConfig) IothubEndpointEventhub {
	...
	_jsii_.Create(
		"azurerm.iothubEndpointEventhub.IothubEndpointEventhub",
...
func (j *jsiiProxy_IothubEndpointEventhub)SetIothubName(val *string) {
...
func (i *jsiiProxy_IothubEndpointEventhub) ResetIothubId() {
	_jsii_.InvokeVoid(
		i,
		"resetIothubId",
		nil, // no parameters
...
func (i *jsiiProxy_IothubEndpointEventhub) ResetIothubName() {
	_jsii_.InvokeVoid(
		i,
		"resetIothubName",
		nil, // no parameters
