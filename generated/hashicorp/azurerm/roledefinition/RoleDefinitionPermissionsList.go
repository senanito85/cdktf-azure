...
func (j *jsiiProxy_RoleDefinitionPermissionsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewRoleDefinitionPermissionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RoleDefinitionPermissionsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"azurerm.roleDefinition.RoleDefinitionPermissionsList",
...
func NewRoleDefinitionPermissionsList_Override(r RoleDefinitionPermissionsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RoleDefinitionPermissionsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (r *jsiiProxy_RoleDefinitionPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RoleDefinitionPermissionsList) Resolve(_context cdktf.IResolveContext) interface{} {
