...
func init() {
	_jsii_.RegisterClass(
		"azurerm.securityCenterWorkspace.SecurityCenterWorkspace",
	...
	_jsii_.RegisterStruct(
		"azurerm.securityCenterWorkspace.SecurityCenterWorkspaceConfig",
		reflect.TypeOf((*SecurityCenterWorkspaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.securityCenterWorkspace.SecurityCenterWorkspaceTimeouts",
