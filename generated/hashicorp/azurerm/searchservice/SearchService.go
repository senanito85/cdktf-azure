...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/searchservice/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/search_service azurerm_search_service}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/search_service azurerm_search_service} Resource.
func NewSearchService(scope constructs.Construct, id *string, config *SearchServiceConfig) SearchService {
	...
	_jsii_.Create(
		"azurerm.searchService.SearchService",
