...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/api_management_identity_provider_microsoft azurerm_api_management_identity_provider_microsoft}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/api_management_identity_provider_microsoft azurerm_api_management_identity_provider_microsoft} Resource.
func NewApiManagementIdentityProviderMicrosoft(scope constructs.Construct, id *string, config *ApiManagementIdentityProviderMicrosoftConfig) ApiManagementIdentityProviderMicrosoft {
	...
	if err := validateNewApiManagementIdentityProviderMicrosoftParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApiManagementIdentityProviderMicrosoft_IsConstruct(x interface{}) *bool {
	...
	if err := validateApiManagementIdentityProviderMicrosoft_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiManagementIdentityProviderMicrosoft_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiManagementIdentityProviderMicrosoft_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiManagementIdentityProviderMicrosoft_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiManagementIdentityProviderMicrosoft_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) ToHclTerraform() interface{} {
	var returns interface{}
