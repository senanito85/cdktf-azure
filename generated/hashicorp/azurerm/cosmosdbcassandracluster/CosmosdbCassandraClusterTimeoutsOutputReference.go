...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/cosmosdbcassandracluster/internal"
)
...
func NewCosmosdbCassandraClusterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CosmosdbCassandraClusterTimeoutsOutputReference {
	...
	if err := validateNewCosmosdbCassandraClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_CosmosdbCassandraClusterTimeoutsOutputReference{}

	_jsii_.Create(
		"azurerm.cosmosdbCassandraCluster.CosmosdbCassandraClusterTimeoutsOutputReference",
