...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/lb_probe azurerm_lb_probe}.
...
func (j *jsiiProxy_LbProbe) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_LbProbe) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/lb_probe azurerm_lb_probe} Resource.
...
func (j *jsiiProxy_LbProbe)SetResourceGroupName(val *string) {
