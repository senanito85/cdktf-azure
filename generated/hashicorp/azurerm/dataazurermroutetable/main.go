...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermRouteTable.DataAzurermRouteTableConfig",
		reflect.TypeOf((*DataAzurermRouteTableConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermRouteTable.DataAzurermRouteTableRoute",
		reflect.TypeOf((*DataAzurermRouteTableRoute)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermRouteTable.DataAzurermRouteTableRouteList",
	...
	_jsii_.RegisterClass(
		"azurerm.dataAzurermRouteTable.DataAzurermRouteTableRouteOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermRouteTable.DataAzurermRouteTableTimeouts",
