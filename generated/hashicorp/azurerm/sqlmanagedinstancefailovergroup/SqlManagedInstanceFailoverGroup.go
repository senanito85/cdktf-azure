...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/sqlmanagedinstancefailovergroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/sql_managed_instance_failover_group azurerm_sql_managed_instance_failover_group}.
...
func (j *jsiiProxy_SqlManagedInstanceFailoverGroup) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/sql_managed_instance_failover_group azurerm_sql_managed_instance_failover_group} Resource.
func NewSqlManagedInstanceFailoverGroup(scope constructs.Construct, id *string, config *SqlManagedInstanceFailoverGroupConfig) SqlManagedInstanceFailoverGroup {
	...
	_jsii_.Create(
		"azurerm.sqlManagedInstanceFailoverGroup.SqlManagedInstanceFailoverGroup",
...
func (j *jsiiProxy_SqlManagedInstanceFailoverGroup)SetCount(val interface{}) {
...
func SqlManagedInstanceFailoverGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSqlManagedInstanceFailoverGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SqlManagedInstanceFailoverGroup) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SqlManagedInstanceFailoverGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SqlManagedInstanceFailoverGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SqlManagedInstanceFailoverGroup) MoveFromId(id *string) {
...
func (s *jsiiProxy_SqlManagedInstanceFailoverGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SqlManagedInstanceFailoverGroup) MoveToId(id *string) {
...
func (s *jsiiProxy_SqlManagedInstanceFailoverGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SqlManagedInstanceFailoverGroup) ToHclTerraform() interface{} {
	var returns interface{}
