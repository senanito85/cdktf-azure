...
func (j *jsiiProxy_CosmosdbAccountGeoLocationOutputReference) Prefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"prefix",
...
func (j *jsiiProxy_CosmosdbAccountGeoLocationOutputReference) PrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"prefixInput",
...
func (j *jsiiProxy_CosmosdbAccountGeoLocationOutputReference)SetPrefix(val *string) {
...
func (c *jsiiProxy_CosmosdbAccountGeoLocationOutputReference) ResetPrefix() {
	_jsii_.InvokeVoid(
		c,
		"resetPrefix",
		nil, // no parameters
