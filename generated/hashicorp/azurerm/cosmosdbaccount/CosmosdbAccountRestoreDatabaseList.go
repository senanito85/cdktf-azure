...
func NewCosmosdbAccountRestoreDatabaseList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbAccountRestoreDatabaseList {
	...
	if err := validateNewCosmosdbAccountRestoreDatabaseListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbAccountRestoreDatabaseList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
