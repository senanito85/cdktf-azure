...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/container_registry_task azurerm_container_registry_task}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/container_registry_task azurerm_container_registry_task} Resource.
...
func ContainerRegistryTask_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateContainerRegistryTask_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerRegistryTask) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ContainerRegistryTask) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ContainerRegistryTask) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ContainerRegistryTask) MoveFromId(id *string) {
...
func (c *jsiiProxy_ContainerRegistryTask) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ContainerRegistryTask) MoveToId(id *string) {
...
func (c *jsiiProxy_ContainerRegistryTask) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ContainerRegistryTask) ToHclTerraform() interface{} {
	var returns interface{}
