...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermAppServiceCertificate.DataAzurermAppServiceCertificateConfig",
		reflect.TypeOf((*DataAzurermAppServiceCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermAppServiceCertificate.DataAzurermAppServiceCertificateTimeouts",
