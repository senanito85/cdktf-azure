...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermExtendedLocations.DataAzurermExtendedLocations",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermExtendedLocations.DataAzurermExtendedLocationsConfig",
		reflect.TypeOf((*DataAzurermExtendedLocationsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermExtendedLocations.DataAzurermExtendedLocationsTimeouts",
