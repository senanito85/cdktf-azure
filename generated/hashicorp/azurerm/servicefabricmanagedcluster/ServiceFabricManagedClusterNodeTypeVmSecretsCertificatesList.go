...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
