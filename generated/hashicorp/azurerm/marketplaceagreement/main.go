...
func init() {
	_jsii_.RegisterClass(
		"azurerm.marketplaceAgreement.MarketplaceAgreement",
	...
	_jsii_.RegisterStruct(
		"azurerm.marketplaceAgreement.MarketplaceAgreementConfig",
		reflect.TypeOf((*MarketplaceAgreementConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.marketplaceAgreement.MarketplaceAgreementTimeouts",
