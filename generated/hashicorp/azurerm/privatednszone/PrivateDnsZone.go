...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/private_dns_zone azurerm_private_dns_zone}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/private_dns_zone azurerm_private_dns_zone} Resource.
func NewPrivateDnsZone(scope constructs.Construct, id *string, config *PrivateDnsZoneConfig) PrivateDnsZone {
	_init_.Initialize()

	if err := validateNewPrivateDnsZoneParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_PrivateDnsZone{}

	_jsii_.Create(
		"azurerm.privateDnsZone.PrivateDnsZone",
...
func PrivateDnsZone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePrivateDnsZone_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func PrivateDnsZone_IsConstruct(x interface{}) *bool {
	...
	if err := validatePrivateDnsZone_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PrivateDnsZone_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePrivateDnsZone_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PrivateDnsZone_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePrivateDnsZone_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PrivateDnsZone) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PrivateDnsZone) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PrivateDnsZone) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PrivateDnsZone) MoveFromId(id *string) {
...
func (p *jsiiProxy_PrivateDnsZone) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PrivateDnsZone) MoveToId(id *string) {
...
func (p *jsiiProxy_PrivateDnsZone) PutSoaRecord(value *PrivateDnsZoneSoaRecord) {
	if err := p.validatePutSoaRecordParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		p,
...
func (p *jsiiProxy_PrivateDnsZone) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PrivateDnsZone) ToHclTerraform() interface{} {
	var returns interface{}
