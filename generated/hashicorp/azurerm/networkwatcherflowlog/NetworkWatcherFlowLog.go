...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/network_watcher_flow_log azurerm_network_watcher_flow_log}.
...
func (j *jsiiProxy_NetworkWatcherFlowLog) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/network_watcher_flow_log azurerm_network_watcher_flow_log} Resource.
func NewNetworkWatcherFlowLog(scope constructs.Construct, id *string, config *NetworkWatcherFlowLogConfig) NetworkWatcherFlowLog {
	...
	if err := validateNewNetworkWatcherFlowLogParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_NetworkWatcherFlowLog)SetCount(val interface{}) {
...
func NetworkWatcherFlowLog_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkWatcherFlowLog_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func NetworkWatcherFlowLog_IsConstruct(x interface{}) *bool {
	...
	if err := validateNetworkWatcherFlowLog_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkWatcherFlowLog_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkWatcherFlowLog_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkWatcherFlowLog_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkWatcherFlowLog_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (n *jsiiProxy_NetworkWatcherFlowLog) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkWatcherFlowLog) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkWatcherFlowLog) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkWatcherFlowLog) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkWatcherFlowLog) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NetworkWatcherFlowLog) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkWatcherFlowLog) PutRetentionPolicy(value *NetworkWatcherFlowLogRetentionPolicy) {
	if err := n.validatePutRetentionPolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NetworkWatcherFlowLog) PutTrafficAnalytics(value *NetworkWatcherFlowLogTrafficAnalytics) {
	if err := n.validatePutTrafficAnalyticsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NetworkWatcherFlowLog) ResetName() {
	_jsii_.InvokeVoid(
		n,
		"resetName",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkWatcherFlowLog) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkWatcherFlowLog) ToHclTerraform() interface{} {
	var returns interface{}
