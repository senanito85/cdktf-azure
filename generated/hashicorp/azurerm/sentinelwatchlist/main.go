...
func init() {
	_jsii_.RegisterClass(
		"azurerm.sentinelWatchlist.SentinelWatchlist",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultDuration", GoMethod: "ResetDefaultDuration"},
	...
	_jsii_.RegisterStruct(
		"azurerm.sentinelWatchlist.SentinelWatchlistTimeouts",
		reflect.TypeOf((*SentinelWatchlistTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.sentinelWatchlist.SentinelWatchlistTimeoutsOutputReference",
