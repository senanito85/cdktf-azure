...
func (s *jsiiProxy_StaticSiteIdentityOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StaticSiteIdentityOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
