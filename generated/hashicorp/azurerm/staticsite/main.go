...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.staticSite.StaticSiteConfig",
		reflect.TypeOf((*StaticSiteConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.staticSite.StaticSiteIdentity",
		reflect.TypeOf((*StaticSiteIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.staticSite.StaticSiteIdentityOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.staticSite.StaticSiteTimeouts",
		reflect.TypeOf((*StaticSiteTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.staticSite.StaticSiteTimeoutsOutputReference",
