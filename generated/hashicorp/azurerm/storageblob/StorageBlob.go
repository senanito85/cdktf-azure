...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/storageblob/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/storage_blob azurerm_storage_blob}.
...
func (j *jsiiProxy_StorageBlob) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/storage_blob azurerm_storage_blob} Resource.
func NewStorageBlob(scope constructs.Construct, id *string, config *StorageBlobConfig) StorageBlob {
	_init_.Initialize()

	if err := validateNewStorageBlobParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_StorageBlob{}

	_jsii_.Create(
		"azurerm.storageBlob.StorageBlob",
...
func (j *jsiiProxy_StorageBlob)SetCount(val interface{}) {
...
func StorageBlob_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStorageBlob_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func StorageBlob_IsConstruct(x interface{}) *bool {
	...
	if err := validateStorageBlob_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StorageBlob) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageBlob) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageBlob) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StorageBlob) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageBlob) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StorageBlob) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageBlob) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StorageBlob) ToHclTerraform() interface{} {
	var returns interface{}
