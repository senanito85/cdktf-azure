...
func NewContainerGroupContainerList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupContainerList {
	...
	_jsii_.Create(
		"azurerm.containerGroup.ContainerGroupContainerList",
...
func (c *jsiiProxy_ContainerGroupContainerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
