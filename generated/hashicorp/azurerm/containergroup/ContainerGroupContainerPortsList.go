...
func NewContainerGroupContainerPortsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupContainerPortsList {
	...
	if err := validateNewContainerGroupContainerPortsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupContainerPortsList{}

	_jsii_.Create(
		"azurerm.containerGroup.ContainerGroupContainerPortsList",
...
func (c *jsiiProxy_ContainerGroupContainerPortsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
