...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/sharedimageversion/internal"
)
...
func NewSharedImageVersionTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SharedImageVersionTimeoutsOutputReference {
	...
	_jsii_.Create(
		"azurerm.sharedImageVersion.SharedImageVersionTimeoutsOutputReference",
