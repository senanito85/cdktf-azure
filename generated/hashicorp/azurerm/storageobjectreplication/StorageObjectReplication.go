...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/storage_object_replication azurerm_storage_object_replication}.
...
func (j *jsiiProxy_StorageObjectReplication) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/storage_object_replication azurerm_storage_object_replication} Resource.
func NewStorageObjectReplication(scope constructs.Construct, id *string, config *StorageObjectReplicationConfig) StorageObjectReplication {
	...
	if err := validateNewStorageObjectReplicationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StorageObjectReplication)SetCount(val interface{}) {
...
func (j *jsiiProxy_StorageObjectReplication)SetDestinationStorageAccountId(val *string) {
	if err := j.validateSetDestinationStorageAccountIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func StorageObjectReplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStorageObjectReplication_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func StorageObjectReplication_IsConstruct(x interface{}) *bool {
	...
	if err := validateStorageObjectReplication_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StorageObjectReplication_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStorageObjectReplication_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StorageObjectReplication_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStorageObjectReplication_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StorageObjectReplication) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageObjectReplication) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageObjectReplication) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StorageObjectReplication) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageObjectReplication) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StorageObjectReplication) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageObjectReplication) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StorageObjectReplication) ToHclTerraform() interface{} {
	var returns interface{}
