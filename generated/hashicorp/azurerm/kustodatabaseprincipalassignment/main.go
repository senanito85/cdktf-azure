...
func init() {
	_jsii_.RegisterClass(
		"azurerm.kustoDatabasePrincipalAssignment.KustoDatabasePrincipalAssignment",
	...
	_jsii_.RegisterStruct(
		"azurerm.kustoDatabasePrincipalAssignment.KustoDatabasePrincipalAssignmentConfig",
		reflect.TypeOf((*KustoDatabasePrincipalAssignmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.kustoDatabasePrincipalAssignment.KustoDatabasePrincipalAssignmentTimeouts",
