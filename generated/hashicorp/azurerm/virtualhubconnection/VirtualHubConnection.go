...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/virtualhubconnection/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/virtual_hub_connection azurerm_virtual_hub_connection}.
type VirtualHubConnection interface {
	...
	HubToVitualNetworkTrafficAllowed() interface{}
	SetHubToVitualNetworkTrafficAllowed(val interface{})
	HubToVitualNetworkTrafficAllowedInput() interface{}
	Id() *string
	SetId(val *string)
	IdInput() *string
	...
	VitualNetworkToHubGatewaysTrafficAllowed() interface{}
	SetVitualNetworkToHubGatewaysTrafficAllowed(val interface{})
	VitualNetworkToHubGatewaysTrafficAllowedInput() interface{}
	...
	ResetHubToVitualNetworkTrafficAllowed()
	ResetId()
	...
	ResetRouting()
	ResetTimeouts()
	ResetVitualNetworkToHubGatewaysTrafficAllowed()
...
func (j *jsiiProxy_VirtualHubConnection) HubToVitualNetworkTrafficAllowed() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VirtualHubConnection) HubToVitualNetworkTrafficAllowedInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"hubToVitualNetworkTrafficAllowedInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_VirtualHubConnection) VitualNetworkToHubGatewaysTrafficAllowed() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VirtualHubConnection) VitualNetworkToHubGatewaysTrafficAllowedInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vitualNetworkToHubGatewaysTrafficAllowedInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/virtual_hub_connection azurerm_virtual_hub_connection} Resource.
func NewVirtualHubConnection(scope constructs.Construct, id *string, config *VirtualHubConnectionConfig) VirtualHubConnection {
	...
	_jsii_.Create(
		"azurerm.virtualHubConnection.VirtualHubConnection",
...
func (j *jsiiProxy_VirtualHubConnection)SetHubToVitualNetworkTrafficAllowed(val interface{}) {
	if err := j.validateSetHubToVitualNetworkTrafficAllowedParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VirtualHubConnection)SetVitualNetworkToHubGatewaysTrafficAllowed(val interface{}) {
	if err := j.validateSetVitualNetworkToHubGatewaysTrafficAllowedParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (v *jsiiProxy_VirtualHubConnection) ResetHubToVitualNetworkTrafficAllowed() {
	_jsii_.InvokeVoid(
		v,
		"resetHubToVitualNetworkTrafficAllowed",
		nil, // no parameters
...
func (v *jsiiProxy_VirtualHubConnection) ResetVitualNetworkToHubGatewaysTrafficAllowed() {
	_jsii_.InvokeVoid(
		v,
		"resetVitualNetworkToHubGatewaysTrafficAllowed",
		nil, // no parameters
