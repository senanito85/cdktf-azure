...
func NewVirtualMachineScaleSetOsProfileSecretsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetOsProfileSecretsList {
	...
	if err := validateNewVirtualMachineScaleSetOsProfileSecretsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
