...
func NewDataAzurermKubernetesClusterWindowsProfileList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterWindowsProfileList {
	...
	if err := validateNewDataAzurermKubernetesClusterWindowsProfileListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterWindowsProfileList{}

	_jsii_.Create(
		"azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterWindowsProfileList",
...
func (d *jsiiProxy_DataAzurermKubernetesClusterWindowsProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
