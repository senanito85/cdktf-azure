...
func NewDataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList {
	...
	if err := validateNewDataAzurermKubernetesClusterOmsAgentOmsAgentIdentityListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
