...
func NewDataAzurermKubernetesClusterServicePrincipalList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterServicePrincipalList {
	...
	if err := validateNewDataAzurermKubernetesClusterServicePrincipalListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterServicePrincipalList{}

	_jsii_.Create(
		"azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterServicePrincipalList",
...
func (d *jsiiProxy_DataAzurermKubernetesClusterServicePrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
