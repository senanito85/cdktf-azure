...
func NewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList {
	...
	if err := validateNewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList{}

	_jsii_.Create(
		"azurerm.dataAzurermKeyVaultCertificate.DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList",
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
