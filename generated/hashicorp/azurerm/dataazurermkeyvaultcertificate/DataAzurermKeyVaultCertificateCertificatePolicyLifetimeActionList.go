...
func NewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList {
	...
	if err := validateNewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList{}

	_jsii_.Create(
		"azurerm.dataAzurermKeyVaultCertificate.DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList",
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
