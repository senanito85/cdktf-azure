...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/botchanneldirectlinespeech/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/bot_channel_direct_line_speech azurerm_bot_channel_direct_line_speech}.
...
func (j *jsiiProxy_BotChannelDirectLineSpeech) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/bot_channel_direct_line_speech azurerm_bot_channel_direct_line_speech} Resource.
func NewBotChannelDirectLineSpeech(scope constructs.Construct, id *string, config *BotChannelDirectLineSpeechConfig) BotChannelDirectLineSpeech {
	...
	if err := validateNewBotChannelDirectLineSpeechParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_BotChannelDirectLineSpeech)SetCognitiveServiceAccessKey(val *string) {
	if err := j.validateSetCognitiveServiceAccessKeyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_BotChannelDirectLineSpeech)SetCognitiveServiceLocation(val *string) {
	if err := j.validateSetCognitiveServiceLocationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_BotChannelDirectLineSpeech)SetCount(val interface{}) {
...
func (j *jsiiProxy_BotChannelDirectLineSpeech)SetCustomSpeechModelId(val *string) {
	if err := j.validateSetCustomSpeechModelIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_BotChannelDirectLineSpeech)SetCustomVoiceDeploymentId(val *string) {
	if err := j.validateSetCustomVoiceDeploymentIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func BotChannelDirectLineSpeech_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBotChannelDirectLineSpeech_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func BotChannelDirectLineSpeech_IsConstruct(x interface{}) *bool {
	...
	if err := validateBotChannelDirectLineSpeech_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func BotChannelDirectLineSpeech_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBotChannelDirectLineSpeech_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func BotChannelDirectLineSpeech_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBotChannelDirectLineSpeech_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) HasResourceMove() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) MoveFromId(id *string) {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) MoveTo(moveTarget *string, index interface{}) {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) MoveToId(id *string) {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) ToHclTerraform() interface{} {
	var returns interface{}
