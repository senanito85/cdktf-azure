...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataFactoryLinkedServiceSnowflake)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.dataFactoryLinkedServiceSnowflake.DataFactoryLinkedServiceSnowflakeConfig",
		reflect.TypeOf((*DataFactoryLinkedServiceSnowflakeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataFactoryLinkedServiceSnowflake.DataFactoryLinkedServiceSnowflakeKeyVaultPassword",
		reflect.TypeOf((*DataFactoryLinkedServiceSnowflakeKeyVaultPassword)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataFactoryLinkedServiceSnowflake.DataFactoryLinkedServiceSnowflakeKeyVaultPasswordOutputReference",
		reflect.TypeOf((*DataFactoryLinkedServiceSnowflakeKeyVaultPasswordOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.dataFactoryLinkedServiceSnowflake.DataFactoryLinkedServiceSnowflakeTimeouts",
		reflect.TypeOf((*DataFactoryLinkedServiceSnowflakeTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataFactoryLinkedServiceSnowflake.DataFactoryLinkedServiceSnowflakeTimeoutsOutputReference",
		reflect.TypeOf((*DataFactoryLinkedServiceSnowflakeTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
