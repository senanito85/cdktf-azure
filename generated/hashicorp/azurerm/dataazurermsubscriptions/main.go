...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermSubscriptions.DataAzurermSubscriptions",
	...
	_jsii_.RegisterClass(
		"azurerm.dataAzurermSubscriptions.DataAzurermSubscriptionsSubscriptionsList",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermSubscriptions.DataAzurermSubscriptionsTimeouts",
		reflect.TypeOf((*DataAzurermSubscriptionsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermSubscriptions.DataAzurermSubscriptionsTimeoutsOutputReference",
