...
func init() {
	_jsii_.RegisterClass(
		"azurerm.mediaAsset.MediaAsset",
		reflect.TypeOf((*MediaAsset)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "alternateId", GoGetter: "AlternateId"},
			_jsii_.MemberProperty{JsiiProperty: "alternateIdInput", GoGetter: "AlternateIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAlternateId", GoMethod: "ResetAlternateId"},
		...
		func() interface{} {
			j := jsiiProxy_MediaAsset{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"azurerm.mediaAsset.MediaAssetConfig",
		reflect.TypeOf((*MediaAssetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.mediaAsset.MediaAssetTimeouts",
		reflect.TypeOf((*MediaAssetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.mediaAsset.MediaAssetTimeoutsOutputReference",
		reflect.TypeOf((*MediaAssetTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
