...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterIsNotNullList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridSystemTopicEventSubscriptionAdvancedFilterIsNotNullList {
	...
	if err := validateNewEventgridSystemTopicEventSubscriptionAdvancedFilterIsNotNullListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterIsNotNullList{}

	_jsii_.Create(
		"azurerm.eventgridSystemTopicEventSubscription.EventgridSystemTopicEventSubscriptionAdvancedFilterIsNotNullList",
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterIsNotNullList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
