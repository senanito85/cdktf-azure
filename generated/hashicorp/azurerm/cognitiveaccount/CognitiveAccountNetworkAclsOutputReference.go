...
func (j *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) VirtualNetworkSubnetIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) VirtualNetworkSubnetIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CognitiveAccountNetworkAclsOutputReference)SetVirtualNetworkSubnetIds(val *[]*string) {
...
func (c *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) ResetVirtualNetworkSubnetIds() {
	_jsii_.InvokeVoid(
		c,
		"resetVirtualNetworkSubnetIds",
		nil, // no parameters
