...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/mssqldatabaseextendedauditingpolicy/internal"
)
...
func NewMssqlDatabaseExtendedAuditingPolicyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MssqlDatabaseExtendedAuditingPolicyTimeoutsOutputReference {
	...
	if err := validateNewMssqlDatabaseExtendedAuditingPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
