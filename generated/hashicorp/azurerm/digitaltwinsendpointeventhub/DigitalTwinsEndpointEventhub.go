...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/digitaltwinsendpointeventhub/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/digital_twins_endpoint_eventhub azurerm_digital_twins_endpoint_eventhub}.
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/digital_twins_endpoint_eventhub azurerm_digital_twins_endpoint_eventhub} Resource.
func NewDigitalTwinsEndpointEventhub(scope constructs.Construct, id *string, config *DigitalTwinsEndpointEventhubConfig) DigitalTwinsEndpointEventhub {
	...
	if err := validateNewDigitalTwinsEndpointEventhubParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DigitalTwinsEndpointEventhub{}

	_jsii_.Create(
		"azurerm.digitalTwinsEndpointEventhub.DigitalTwinsEndpointEventhub",
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub)SetCount(val interface{}) {
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub)SetEventhubPrimaryConnectionString(val *string) {
	if err := j.validateSetEventhubPrimaryConnectionStringParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub)SetEventhubSecondaryConnectionString(val *string) {
	if err := j.validateSetEventhubSecondaryConnectionStringParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DigitalTwinsEndpointEventhub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDigitalTwinsEndpointEventhub_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DigitalTwinsEndpointEventhub_IsConstruct(x interface{}) *bool {
	...
	if err := validateDigitalTwinsEndpointEventhub_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DigitalTwinsEndpointEventhub_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDigitalTwinsEndpointEventhub_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DigitalTwinsEndpointEventhub_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDigitalTwinsEndpointEventhub_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) MoveFromId(id *string) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) MoveToId(id *string) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) ToHclTerraform() interface{} {
	var returns interface{}
