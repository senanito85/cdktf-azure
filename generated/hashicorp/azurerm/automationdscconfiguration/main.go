...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AutomationDscConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLogVerbose", GoMethod: "ResetLogVerbose"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AutomationDscConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.automationDscConfiguration.AutomationDscConfigurationTimeouts",
		reflect.TypeOf((*AutomationDscConfigurationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.automationDscConfiguration.AutomationDscConfigurationTimeoutsOutputReference",
		reflect.TypeOf((*AutomationDscConfigurationTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
