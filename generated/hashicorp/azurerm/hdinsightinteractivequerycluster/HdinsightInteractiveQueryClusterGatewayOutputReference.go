...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference)SetEnabled(val interface{}) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		h,
		"resetEnabled",
		nil, // no parameters
