...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/log_analytics_workspace azurerm_log_analytics_workspace}.
type LogAnalyticsWorkspace interface {
	...
	ReservationCapcityInGbPerDay() *float64
	SetReservationCapcityInGbPerDay(val *float64)
	ReservationCapcityInGbPerDayInput() *float64
	...
	ResetReservationCapcityInGbPerDay()
...
func (j *jsiiProxy_LogAnalyticsWorkspace) PortalUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"portalUrl",
...
func (j *jsiiProxy_LogAnalyticsWorkspace) ReservationCapcityInGbPerDay() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LogAnalyticsWorkspace) ReservationCapcityInGbPerDayInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"reservationCapcityInGbPerDayInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/log_analytics_workspace azurerm_log_analytics_workspace} Resource.
...
func (j *jsiiProxy_LogAnalyticsWorkspace)SetReservationCapcityInGbPerDay(val *float64) {
	if err := j.validateSetReservationCapcityInGbPerDayParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (l *jsiiProxy_LogAnalyticsWorkspace) ResetReservationCapcityInGbPerDay() {
	_jsii_.InvokeVoid(
		l,
		"resetReservationCapcityInGbPerDay",
		nil, // no parameters
