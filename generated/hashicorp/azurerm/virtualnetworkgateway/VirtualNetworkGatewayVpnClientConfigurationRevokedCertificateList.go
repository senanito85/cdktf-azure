...
func NewVirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList {
	...
	if err := validateNewVirtualNetworkGatewayVpnClientConfigurationRevokedCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
