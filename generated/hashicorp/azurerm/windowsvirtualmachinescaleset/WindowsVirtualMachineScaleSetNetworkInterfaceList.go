...
func NewWindowsVirtualMachineScaleSetNetworkInterfaceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineScaleSetNetworkInterfaceList {
	...
	if err := validateNewWindowsVirtualMachineScaleSetNetworkInterfaceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetNetworkInterfaceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
