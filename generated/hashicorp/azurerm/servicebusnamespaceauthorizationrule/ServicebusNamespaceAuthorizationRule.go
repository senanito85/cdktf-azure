...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/servicebus_namespace_authorization_rule azurerm_servicebus_namespace_authorization_rule}.
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) NamespaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceName",
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) NamespaceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceNameInput",
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/servicebus_namespace_authorization_rule azurerm_servicebus_namespace_authorization_rule} Resource.
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule)SetNamespaceName(val *string) {
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule)SetResourceGroupName(val *string) {
...
func ServicebusNamespaceAuthorizationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicebusNamespaceAuthorizationRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServicebusNamespaceAuthorizationRule) ResetNamespaceId() {
	_jsii_.InvokeVoid(
		s,
		"resetNamespaceId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusNamespaceAuthorizationRule) ResetNamespaceName() {
	_jsii_.InvokeVoid(
		s,
		"resetNamespaceName",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusNamespaceAuthorizationRule) ResetResourceGroupName() {
	_jsii_.InvokeVoid(
		s,
		"resetResourceGroupName",
		nil, // no parameters
