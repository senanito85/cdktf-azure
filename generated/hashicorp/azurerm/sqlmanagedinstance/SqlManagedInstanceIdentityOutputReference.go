...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/sqlmanagedinstance/internal"
)
...
func NewSqlManagedInstanceIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SqlManagedInstanceIdentityOutputReference {
	...
	if err := validateNewSqlManagedInstanceIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SqlManagedInstanceIdentityOutputReference{}

	_jsii_.Create(
		"azurerm.sqlManagedInstance.SqlManagedInstanceIdentityOutputReference",
