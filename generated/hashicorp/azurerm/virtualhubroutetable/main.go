...
func init() {
	_jsii_.RegisterClass(
		"azurerm.virtualHubRouteTable.VirtualHubRouteTable",
	...
	_jsii_.RegisterStruct(
		"azurerm.virtualHubRouteTable.VirtualHubRouteTableConfig",
		reflect.TypeOf((*VirtualHubRouteTableConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.virtualHubRouteTable.VirtualHubRouteTableRoute",
	...
	_jsii_.RegisterClass(
		"azurerm.virtualHubRouteTable.VirtualHubRouteTableRouteOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.virtualHubRouteTable.VirtualHubRouteTableTimeouts",
		reflect.TypeOf((*VirtualHubRouteTableTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.virtualHubRouteTable.VirtualHubRouteTableTimeoutsOutputReference",
