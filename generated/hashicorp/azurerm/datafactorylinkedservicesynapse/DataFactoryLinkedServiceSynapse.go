...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/datafactorylinkedservicesynapse/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_linked_service_synapse azurerm_data_factory_linked_service_synapse}.
...
func (j *jsiiProxy_DataFactoryLinkedServiceSynapse) DataFactoryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataFactoryName",
...
func (j *jsiiProxy_DataFactoryLinkedServiceSynapse) DataFactoryNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataFactoryLinkedServiceSynapse) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_DataFactoryLinkedServiceSynapse) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_linked_service_synapse azurerm_data_factory_linked_service_synapse} Resource.
func NewDataFactoryLinkedServiceSynapse(scope constructs.Construct, id *string, config *DataFactoryLinkedServiceSynapseConfig) DataFactoryLinkedServiceSynapse {
	...
	_jsii_.Create(
		"azurerm.dataFactoryLinkedServiceSynapse.DataFactoryLinkedServiceSynapse",
...
func (j *jsiiProxy_DataFactoryLinkedServiceSynapse)SetDataFactoryName(val *string) {
...
func (j *jsiiProxy_DataFactoryLinkedServiceSynapse)SetResourceGroupName(val *string) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) ResetDataFactoryId() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryId",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) ResetDataFactoryName() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryName",
		nil, // no parameters
