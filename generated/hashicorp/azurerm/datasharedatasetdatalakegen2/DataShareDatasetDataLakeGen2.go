...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/datasharedatasetdatalakegen2/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_share_dataset_data_lake_gen2 azurerm_data_share_dataset_data_lake_gen2}.
...
func (j *jsiiProxy_DataShareDatasetDataLakeGen2) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_share_dataset_data_lake_gen2 azurerm_data_share_dataset_data_lake_gen2} Resource.
func NewDataShareDatasetDataLakeGen2(scope constructs.Construct, id *string, config *DataShareDatasetDataLakeGen2Config) DataShareDatasetDataLakeGen2 {
	...
	if err := validateNewDataShareDatasetDataLakeGen2Parameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataShareDatasetDataLakeGen2{}

	_jsii_.Create(
		"azurerm.dataShareDatasetDataLakeGen2.DataShareDatasetDataLakeGen2",
...
func (j *jsiiProxy_DataShareDatasetDataLakeGen2)SetCount(val interface{}) {
...
func DataShareDatasetDataLakeGen2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataShareDatasetDataLakeGen2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataShareDatasetDataLakeGen2_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataShareDatasetDataLakeGen2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataShareDatasetDataLakeGen2_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataShareDatasetDataLakeGen2_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataShareDatasetDataLakeGen2_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataShareDatasetDataLakeGen2_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataShareDatasetDataLakeGen2) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataShareDatasetDataLakeGen2) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataShareDatasetDataLakeGen2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DataShareDatasetDataLakeGen2) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataShareDatasetDataLakeGen2) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DataShareDatasetDataLakeGen2) MoveToId(id *string) {
...
func (d *jsiiProxy_DataShareDatasetDataLakeGen2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataShareDatasetDataLakeGen2) ToHclTerraform() interface{} {
	var returns interface{}
