...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/servicebusqueueauthorizationrule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/servicebus_queue_authorization_rule azurerm_servicebus_queue_authorization_rule}.
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) NamespaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceName",
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) NamespaceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceNameInput",
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) QueueName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queueName",
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) QueueNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queueNameInput",
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/servicebus_queue_authorization_rule azurerm_servicebus_queue_authorization_rule} Resource.
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule)SetNamespaceName(val *string) {
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule)SetQueueName(val *string) {
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule)SetResourceGroupName(val *string) {
...
func ServicebusQueueAuthorizationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServicebusQueueAuthorizationRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) ResetNamespaceName() {
	_jsii_.InvokeVoid(
		s,
		"resetNamespaceName",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) ResetQueueId() {
	_jsii_.InvokeVoid(
		s,
		"resetQueueId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) ResetQueueName() {
	_jsii_.InvokeVoid(
		s,
		"resetQueueName",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) ResetResourceGroupName() {
	_jsii_.InvokeVoid(
		s,
		"resetResourceGroupName",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) ToHclTerraform() interface{} {
	var returns interface{}
