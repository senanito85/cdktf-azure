...
func init() {
	_jsii_.RegisterClass(
		"azurerm.apiManagementEmailTemplate.ApiManagementEmailTemplate",
	...
	_jsii_.RegisterStruct(
		"azurerm.apiManagementEmailTemplate.ApiManagementEmailTemplateConfig",
		reflect.TypeOf((*ApiManagementEmailTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.apiManagementEmailTemplate.ApiManagementEmailTemplateTimeouts",
