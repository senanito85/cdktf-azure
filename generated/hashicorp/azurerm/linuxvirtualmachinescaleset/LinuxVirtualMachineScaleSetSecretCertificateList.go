...
func NewLinuxVirtualMachineScaleSetSecretCertificateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineScaleSetSecretCertificateList {
	...
	if err := validateNewLinuxVirtualMachineScaleSetSecretCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetSecretCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
