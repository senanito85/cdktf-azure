...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/managedapplication/internal"
)
...
func NewManagedApplicationTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ManagedApplicationTimeoutsOutputReference {
	...
	_jsii_.Create(
		"azurerm.managedApplication.ManagedApplicationTimeoutsOutputReference",
