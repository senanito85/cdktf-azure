...
type FirewallPolicyDnsOutputReference interface {
	...
	NetworkRuleFqdnEnabled() interface{}
	SetNetworkRuleFqdnEnabled(val interface{})
	NetworkRuleFqdnEnabledInput() interface{}
...
func (j *jsiiProxy_FirewallPolicyDnsOutputReference) NetworkRuleFqdnEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FirewallPolicyDnsOutputReference) NetworkRuleFqdnEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"networkRuleFqdnEnabledInput",
		&returns,
	)
	return returns
}
...
func NewFirewallPolicyDnsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FirewallPolicyDnsOutputReference {
	...
	_jsii_.Create(
		"azurerm.firewallPolicy.FirewallPolicyDnsOutputReference",
...
func (j *jsiiProxy_FirewallPolicyDnsOutputReference)SetNetworkRuleFqdnEnabled(val interface{}) {
	if err := j.validateSetNetworkRuleFqdnEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (f *jsiiProxy_FirewallPolicyDnsOutputReference) ResetNetworkRuleFqdnEnabled() {
	_jsii_.InvokeVoid(
		f,
		"resetNetworkRuleFqdnEnabled",
		nil, // no parameters
