...
type FirewallPolicyIdentityOutputReference interface {
	...
	SetUserAssignedIdentityIds(val *[]*string)
	UserAssignedIdentityIdsInput() *[]*string
	// Experimental.
	ComputeFqn() *string
	// Experimental.
...
func (j *jsiiProxy_FirewallPolicyIdentityOutputReference) UserAssignedIdentityIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FirewallPolicyIdentityOutputReference) UserAssignedIdentityIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"userAssignedIdentityIdsInput",
		&returns,
	)
	return returns
}
...
func NewFirewallPolicyIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FirewallPolicyIdentityOutputReference {
	...
	if err := validateNewFirewallPolicyIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_FirewallPolicyIdentityOutputReference{}

	_jsii_.Create(
		"azurerm.firewallPolicy.FirewallPolicyIdentityOutputReference",
...
func (j *jsiiProxy_FirewallPolicyIdentityOutputReference)SetUserAssignedIdentityIds(val *[]*string) {
	if err := j.validateSetUserAssignedIdentityIdsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (f *jsiiProxy_FirewallPolicyIdentityOutputReference) ResetUserAssignedIdentityIds() {
	_jsii_.InvokeVoid(
		f,
		"resetUserAssignedIdentityIds",
		nil, // no parameters
