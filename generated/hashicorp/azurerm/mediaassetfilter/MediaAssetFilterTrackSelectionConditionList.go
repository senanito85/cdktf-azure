...
func NewMediaAssetFilterTrackSelectionConditionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaAssetFilterTrackSelectionConditionList {
	...
	if err := validateNewMediaAssetFilterTrackSelectionConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MediaAssetFilterTrackSelectionConditionList{}

	_jsii_.Create(
		"azurerm.mediaAssetFilter.MediaAssetFilterTrackSelectionConditionList",
...
func (m *jsiiProxy_MediaAssetFilterTrackSelectionConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
