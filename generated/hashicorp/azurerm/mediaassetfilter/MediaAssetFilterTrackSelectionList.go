...
func NewMediaAssetFilterTrackSelectionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaAssetFilterTrackSelectionList {
	...
	if err := validateNewMediaAssetFilterTrackSelectionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MediaAssetFilterTrackSelectionList{}

	_jsii_.Create(
		"azurerm.mediaAssetFilter.MediaAssetFilterTrackSelectionList",
...
func (m *jsiiProxy_MediaAssetFilterTrackSelectionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
