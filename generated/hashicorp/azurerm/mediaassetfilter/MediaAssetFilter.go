...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/media_asset_filter azurerm_media_asset_filter}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/media_asset_filter azurerm_media_asset_filter} Resource.
func NewMediaAssetFilter(scope constructs.Construct, id *string, config *MediaAssetFilterConfig) MediaAssetFilter {
	...
	_jsii_.Create(
		"azurerm.mediaAssetFilter.MediaAssetFilter",
...
func MediaAssetFilter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMediaAssetFilter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MediaAssetFilter) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MediaAssetFilter) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MediaAssetFilter) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MediaAssetFilter) MoveFromId(id *string) {
...
func (m *jsiiProxy_MediaAssetFilter) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MediaAssetFilter) MoveToId(id *string) {
...
func (m *jsiiProxy_MediaAssetFilter) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MediaAssetFilter) ToHclTerraform() interface{} {
	var returns interface{}
