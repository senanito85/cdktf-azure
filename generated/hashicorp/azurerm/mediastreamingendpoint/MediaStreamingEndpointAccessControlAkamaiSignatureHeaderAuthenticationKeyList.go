...
func NewMediaStreamingEndpointAccessControlAkamaiSignatureHeaderAuthenticationKeyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaStreamingEndpointAccessControlAkamaiSignatureHeaderAuthenticationKeyList {
	...
	if err := validateNewMediaStreamingEndpointAccessControlAkamaiSignatureHeaderAuthenticationKeyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MediaStreamingEndpointAccessControlAkamaiSignatureHeaderAuthenticationKeyList{}

	_jsii_.Create(
		"azurerm.mediaStreamingEndpoint.MediaStreamingEndpointAccessControlAkamaiSignatureHeaderAuthenticationKeyList",
...
func (m *jsiiProxy_MediaStreamingEndpointAccessControlAkamaiSignatureHeaderAuthenticationKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
