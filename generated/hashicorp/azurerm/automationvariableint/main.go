...
func init() {
	_jsii_.RegisterClass(
		"azurerm.automationVariableInt.AutomationVariableInt",
	...
	_jsii_.RegisterStruct(
		"azurerm.automationVariableInt.AutomationVariableIntConfig",
		reflect.TypeOf((*AutomationVariableIntConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.automationVariableInt.AutomationVariableIntTimeouts",
		reflect.TypeOf((*AutomationVariableIntTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.automationVariableInt.AutomationVariableIntTimeoutsOutputReference",
