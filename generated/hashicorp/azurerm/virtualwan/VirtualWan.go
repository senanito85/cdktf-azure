...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/virtual_wan azurerm_virtual_wan}.
type VirtualWan interface {
	...
	SetAllowVnetToVnetTraffic(val interface{})
	AllowVnetToVnetTrafficInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_VirtualWan) AllowVnetToVnetTraffic() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VirtualWan) AllowVnetToVnetTrafficInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"allowVnetToVnetTrafficInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/virtual_wan azurerm_virtual_wan} Resource.
...
func (j *jsiiProxy_VirtualWan)SetAllowVnetToVnetTraffic(val interface{}) {
	if err := j.validateSetAllowVnetToVnetTrafficParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (v *jsiiProxy_VirtualWan) ResetAllowVnetToVnetTraffic() {
	_jsii_.InvokeVoid(
		v,
		"resetAllowVnetToVnetTraffic",
		nil, // no parameters
