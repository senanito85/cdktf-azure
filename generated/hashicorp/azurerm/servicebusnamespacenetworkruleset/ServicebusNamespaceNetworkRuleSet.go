...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/servicebus_namespace_network_rule_set azurerm_servicebus_namespace_network_rule_set}.
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSet) NamespaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceName",
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSet) NamespaceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceNameInput",
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSet) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSet) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/servicebus_namespace_network_rule_set azurerm_servicebus_namespace_network_rule_set} Resource.
func NewServicebusNamespaceNetworkRuleSet(scope constructs.Construct, id *string, config *ServicebusNamespaceNetworkRuleSetConfig) ServicebusNamespaceNetworkRuleSet {
	...
	_jsii_.Create(
		"azurerm.servicebusNamespaceNetworkRuleSet.ServicebusNamespaceNetworkRuleSet",
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSet)SetNamespaceName(val *string) {
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSet)SetResourceGroupName(val *string) {
...
// Generates CDKTF code for importing a ServicebusNamespaceNetworkRuleSet resource upon running "cdktf plan <stack-name>".
func ServicebusNamespaceNetworkRuleSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServicebusNamespaceNetworkRuleSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) ResetNamespaceId() {
	_jsii_.InvokeVoid(
		s,
		"resetNamespaceId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) ResetNamespaceName() {
	_jsii_.InvokeVoid(
		s,
		"resetNamespaceName",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) ResetResourceGroupName() {
	_jsii_.InvokeVoid(
		s,
		"resetResourceGroupName",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSet) ToHclTerraform() interface{} {
	var returns interface{}
