...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/key_vault_certificate azurerm_key_vault_certificate}.
...
func (j *jsiiProxy_KeyVaultCertificate) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/key_vault_certificate azurerm_key_vault_certificate} Resource.
...
func (j *jsiiProxy_KeyVaultCertificate)SetCount(val interface{}) {
...
func KeyVaultCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateKeyVaultCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KeyVaultCertificate) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KeyVaultCertificate) HasResourceMove() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KeyVaultCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KeyVaultCertificate) MoveFromId(id *string) {
...
func (k *jsiiProxy_KeyVaultCertificate) MoveTo(moveTarget *string, index interface{}) {
...
func (k *jsiiProxy_KeyVaultCertificate) MoveToId(id *string) {
...
func (k *jsiiProxy_KeyVaultCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KeyVaultCertificate) ToHclTerraform() interface{} {
	var returns interface{}
