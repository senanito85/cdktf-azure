...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/vpn_gateway_nat_rule azurerm_vpn_gateway_nat_rule}.
...
func (j *jsiiProxy_VpnGatewayNatRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/vpn_gateway_nat_rule azurerm_vpn_gateway_nat_rule} Resource.
func NewVpnGatewayNatRule(scope constructs.Construct, id *string, config *VpnGatewayNatRuleConfig) VpnGatewayNatRule {
	_init_.Initialize()

	if err := validateNewVpnGatewayNatRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VpnGatewayNatRule)SetCount(val interface{}) {
...
func VpnGatewayNatRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpnGatewayNatRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VpnGatewayNatRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateVpnGatewayNatRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VpnGatewayNatRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpnGatewayNatRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VpnGatewayNatRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpnGatewayNatRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VpnGatewayNatRule) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpnGatewayNatRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpnGatewayNatRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VpnGatewayNatRule) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpnGatewayNatRule) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VpnGatewayNatRule) MoveToId(id *string) {
...
func (v *jsiiProxy_VpnGatewayNatRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpnGatewayNatRule) ToHclTerraform() interface{} {
	var returns interface{}
