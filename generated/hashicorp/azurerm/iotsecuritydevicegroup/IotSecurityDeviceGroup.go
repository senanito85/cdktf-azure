...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/iot_security_device_group azurerm_iot_security_device_group}.
...
func (j *jsiiProxy_IotSecurityDeviceGroup) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/iot_security_device_group azurerm_iot_security_device_group} Resource.
func NewIotSecurityDeviceGroup(scope constructs.Construct, id *string, config *IotSecurityDeviceGroupConfig) IotSecurityDeviceGroup {
	...
	_jsii_.Create(
		"azurerm.iotSecurityDeviceGroup.IotSecurityDeviceGroup",
...
func (j *jsiiProxy_IotSecurityDeviceGroup)SetCount(val interface{}) {
...
func IotSecurityDeviceGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotSecurityDeviceGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotSecurityDeviceGroup) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotSecurityDeviceGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotSecurityDeviceGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotSecurityDeviceGroup) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotSecurityDeviceGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IotSecurityDeviceGroup) MoveToId(id *string) {
...
func (i *jsiiProxy_IotSecurityDeviceGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotSecurityDeviceGroup) ToHclTerraform() interface{} {
	var returns interface{}
