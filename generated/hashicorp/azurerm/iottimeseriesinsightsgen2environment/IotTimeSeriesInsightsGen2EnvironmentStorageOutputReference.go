...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/iottimeseriesinsightsgen2environment/internal"
)
...
func NewIotTimeSeriesInsightsGen2EnvironmentStorageOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTimeSeriesInsightsGen2EnvironmentStorageOutputReference {
	...
	if err := validateNewIotTimeSeriesInsightsGen2EnvironmentStorageOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
