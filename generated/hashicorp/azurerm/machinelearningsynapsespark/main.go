...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkConfig",
		reflect.TypeOf((*MachineLearningSynapseSparkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkIdentity",
		reflect.TypeOf((*MachineLearningSynapseSparkIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkIdentityOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkTimeouts",
		reflect.TypeOf((*MachineLearningSynapseSparkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkTimeoutsOutputReference",
