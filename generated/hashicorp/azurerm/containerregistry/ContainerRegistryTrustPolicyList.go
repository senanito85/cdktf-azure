...
func NewContainerRegistryTrustPolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryTrustPolicyList {
	...
	if err := validateNewContainerRegistryTrustPolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerRegistryTrustPolicyList{}

	_jsii_.Create(
		"azurerm.containerRegistry.ContainerRegistryTrustPolicyList",
...
func (c *jsiiProxy_ContainerRegistryTrustPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
