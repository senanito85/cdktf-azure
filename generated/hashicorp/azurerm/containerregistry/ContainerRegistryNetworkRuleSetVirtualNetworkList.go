...
func NewContainerRegistryNetworkRuleSetVirtualNetworkList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryNetworkRuleSetVirtualNetworkList {
	...
	if err := validateNewContainerRegistryNetworkRuleSetVirtualNetworkListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerRegistryNetworkRuleSetVirtualNetworkList{}

	_jsii_.Create(
		"azurerm.containerRegistry.ContainerRegistryNetworkRuleSetVirtualNetworkList",
...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetVirtualNetworkList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
