...
func NewContainerRegistryRetentionPolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryRetentionPolicyList {
	...
	if err := validateNewContainerRegistryRetentionPolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerRegistryRetentionPolicyList{}

	_jsii_.Create(
		"azurerm.containerRegistry.ContainerRegistryRetentionPolicyList",
...
func (c *jsiiProxy_ContainerRegistryRetentionPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
