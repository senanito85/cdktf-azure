...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataProtectionBackupVault.DataProtectionBackupVaultConfig",
		reflect.TypeOf((*DataProtectionBackupVaultConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataProtectionBackupVault.DataProtectionBackupVaultIdentity",
		reflect.TypeOf((*DataProtectionBackupVaultIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataProtectionBackupVault.DataProtectionBackupVaultIdentityOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataProtectionBackupVault.DataProtectionBackupVaultTimeouts",
		reflect.TypeOf((*DataProtectionBackupVaultTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataProtectionBackupVault.DataProtectionBackupVaultTimeoutsOutputReference",
