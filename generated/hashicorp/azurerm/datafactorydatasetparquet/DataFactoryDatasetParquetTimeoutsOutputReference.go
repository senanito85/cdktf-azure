...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/datafactorydatasetparquet/internal"
)
...
func NewDataFactoryDatasetParquetTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryDatasetParquetTimeoutsOutputReference {
	...
	if err := validateNewDataFactoryDatasetParquetTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryDatasetParquetTimeoutsOutputReference{}

	_jsii_.Create(
		"azurerm.dataFactoryDatasetParquet.DataFactoryDatasetParquetTimeoutsOutputReference",
