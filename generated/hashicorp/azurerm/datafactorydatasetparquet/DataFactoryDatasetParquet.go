...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_dataset_parquet azurerm_data_factory_dataset_parquet}.
...
func (j *jsiiProxy_DataFactoryDatasetParquet) DataFactoryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataFactoryName",
...
func (j *jsiiProxy_DataFactoryDatasetParquet) DataFactoryNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataFactoryDatasetParquet) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_DataFactoryDatasetParquet) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_dataset_parquet azurerm_data_factory_dataset_parquet} Resource.
func NewDataFactoryDatasetParquet(scope constructs.Construct, id *string, config *DataFactoryDatasetParquetConfig) DataFactoryDatasetParquet {
	...
	_jsii_.Create(
		"azurerm.dataFactoryDatasetParquet.DataFactoryDatasetParquet",
...
func (j *jsiiProxy_DataFactoryDatasetParquet)SetDataFactoryName(val *string) {
...
func (j *jsiiProxy_DataFactoryDatasetParquet)SetResourceGroupName(val *string) {
...
func (d *jsiiProxy_DataFactoryDatasetParquet) ResetDataFactoryId() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryId",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryDatasetParquet) ResetDataFactoryName() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryName",
		nil, // no parameters
