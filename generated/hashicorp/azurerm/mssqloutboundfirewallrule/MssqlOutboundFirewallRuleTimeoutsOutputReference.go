...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/mssqloutboundfirewallrule/internal"
)
...
func NewMssqlOutboundFirewallRuleTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MssqlOutboundFirewallRuleTimeoutsOutputReference {
	...
	if err := validateNewMssqlOutboundFirewallRuleTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
