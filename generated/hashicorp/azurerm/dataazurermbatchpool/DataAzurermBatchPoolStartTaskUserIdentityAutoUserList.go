...
func NewDataAzurermBatchPoolStartTaskUserIdentityAutoUserList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermBatchPoolStartTaskUserIdentityAutoUserList {
	...
	_jsii_.Create(
		"azurerm.dataAzurermBatchPool.DataAzurermBatchPoolStartTaskUserIdentityAutoUserList",
...
func (d *jsiiProxy_DataAzurermBatchPoolStartTaskUserIdentityAutoUserList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
