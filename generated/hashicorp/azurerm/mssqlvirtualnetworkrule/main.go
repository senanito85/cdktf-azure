...
func init() {
	_jsii_.RegisterClass(
		"azurerm.mssqlVirtualNetworkRule.MssqlVirtualNetworkRule",
	...
	_jsii_.RegisterStruct(
		"azurerm.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleConfig",
		reflect.TypeOf((*MssqlVirtualNetworkRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleTimeouts",
