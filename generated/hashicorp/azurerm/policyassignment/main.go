...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PolicyAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.policyAssignment.PolicyAssignmentConfig",
		reflect.TypeOf((*PolicyAssignmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.policyAssignment.PolicyAssignmentIdentity",
		reflect.TypeOf((*PolicyAssignmentIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.policyAssignment.PolicyAssignmentIdentityOutputReference",
		reflect.TypeOf((*PolicyAssignmentIdentityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.policyAssignment.PolicyAssignmentTimeouts",
		reflect.TypeOf((*PolicyAssignmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.policyAssignment.PolicyAssignmentTimeoutsOutputReference",
		reflect.TypeOf((*PolicyAssignmentTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
