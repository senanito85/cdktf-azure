...
func NewEventgridEventSubscriptionAdvancedFilterNumberGreaterThanList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterNumberGreaterThanList {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterNumberGreaterThanListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberGreaterThanList{}

	_jsii_.Create(
		"azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterNumberGreaterThanList",
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberGreaterThanList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
