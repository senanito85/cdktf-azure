...
func NewEventgridEventSubscriptionAdvancedFilterBoolEqualsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterBoolEqualsList {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterBoolEqualsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterBoolEqualsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
