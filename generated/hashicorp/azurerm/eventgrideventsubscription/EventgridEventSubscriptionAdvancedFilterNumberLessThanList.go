...
func NewEventgridEventSubscriptionAdvancedFilterNumberLessThanList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterNumberLessThanList {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterNumberLessThanListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberLessThanList{}

	_jsii_.Create(
		"azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterNumberLessThanList",
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberLessThanList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
