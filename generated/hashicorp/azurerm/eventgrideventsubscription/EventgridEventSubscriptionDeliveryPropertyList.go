...
func NewEventgridEventSubscriptionDeliveryPropertyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionDeliveryPropertyList {
	...
	if err := validateNewEventgridEventSubscriptionDeliveryPropertyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionDeliveryPropertyList{}

	_jsii_.Create(
		"azurerm.eventgridEventSubscription.EventgridEventSubscriptionDeliveryPropertyList",
...
func (e *jsiiProxy_EventgridEventSubscriptionDeliveryPropertyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
