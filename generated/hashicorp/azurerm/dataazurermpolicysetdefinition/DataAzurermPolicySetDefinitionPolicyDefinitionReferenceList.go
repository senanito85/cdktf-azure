...
func (j *jsiiProxy_DataAzurermPolicySetDefinitionPolicyDefinitionReferenceList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermPolicySetDefinitionPolicyDefinitionReferenceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermPolicySetDefinitionPolicyDefinitionReferenceList {
	_init_.Initialize()
...
func NewDataAzurermPolicySetDefinitionPolicyDefinitionReferenceList_Override(d DataAzurermPolicySetDefinitionPolicyDefinitionReferenceList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermPolicySetDefinitionPolicyDefinitionReferenceList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermPolicySetDefinitionPolicyDefinitionReferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermPolicySetDefinitionPolicyDefinitionReferenceList) Resolve(_context cdktf.IResolveContext) interface{} {
