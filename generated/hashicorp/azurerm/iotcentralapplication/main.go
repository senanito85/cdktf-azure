...
func init() {
	_jsii_.RegisterClass(
		"azurerm.iotcentralApplication.IotcentralApplication",
	...
	_jsii_.RegisterStruct(
		"azurerm.iotcentralApplication.IotcentralApplicationConfig",
		reflect.TypeOf((*IotcentralApplicationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.iotcentralApplication.IotcentralApplicationTimeouts",
		reflect.TypeOf((*IotcentralApplicationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.iotcentralApplication.IotcentralApplicationTimeoutsOutputReference",
