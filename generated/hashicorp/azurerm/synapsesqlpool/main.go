...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.synapseSqlPool.SynapseSqlPoolConfig",
		reflect.TypeOf((*SynapseSqlPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.synapseSqlPool.SynapseSqlPoolRestore",
		reflect.TypeOf((*SynapseSqlPoolRestore)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.synapseSqlPool.SynapseSqlPoolRestoreOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.synapseSqlPool.SynapseSqlPoolTimeouts",
		reflect.TypeOf((*SynapseSqlPoolTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.synapseSqlPool.SynapseSqlPoolTimeoutsOutputReference",
