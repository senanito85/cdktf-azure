...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/media_streaming_policy azurerm_media_streaming_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/media_streaming_policy azurerm_media_streaming_policy} Resource.
func NewMediaStreamingPolicy(scope constructs.Construct, id *string, config *MediaStreamingPolicyConfig) MediaStreamingPolicy {
	_init_.Initialize()

	if err := validateNewMediaStreamingPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MediaStreamingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMediaStreamingPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MediaStreamingPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateMediaStreamingPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MediaStreamingPolicy_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateMediaStreamingPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MediaStreamingPolicy_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateMediaStreamingPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MediaStreamingPolicy) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MediaStreamingPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MediaStreamingPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MediaStreamingPolicy) MoveFromId(id *string) {
...
func (m *jsiiProxy_MediaStreamingPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MediaStreamingPolicy) MoveToId(id *string) {
...
func (m *jsiiProxy_MediaStreamingPolicy) PutCommonEncryptionCbcs(value *MediaStreamingPolicyCommonEncryptionCbcs) {
	if err := m.validatePutCommonEncryptionCbcsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MediaStreamingPolicy) PutCommonEncryptionCenc(value *MediaStreamingPolicyCommonEncryptionCenc) {
	if err := m.validatePutCommonEncryptionCencParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MediaStreamingPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MediaStreamingPolicy) ToHclTerraform() interface{} {
	var returns interface{}
