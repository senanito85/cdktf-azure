...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.snapshot.SnapshotConfig",
		reflect.TypeOf((*SnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.snapshot.SnapshotEncryptionSettings",
		reflect.TypeOf((*SnapshotEncryptionSettings)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.snapshot.SnapshotEncryptionSettingsDiskEncryptionKey",
	...
	_jsii_.RegisterStruct(
		"azurerm.snapshot.SnapshotEncryptionSettingsKeyEncryptionKey",
	...
	_jsii_.RegisterStruct(
		"azurerm.snapshot.SnapshotTimeouts",
		reflect.TypeOf((*SnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.snapshot.SnapshotTimeoutsOutputReference",
