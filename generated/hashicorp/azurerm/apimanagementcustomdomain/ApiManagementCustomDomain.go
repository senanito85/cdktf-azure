...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/api_management_custom_domain azurerm_api_management_custom_domain}.
type ApiManagementCustomDomain interface {
	...
	Proxy() ApiManagementCustomDomainProxyList
...
func (j *jsiiProxy_ApiManagementCustomDomain) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ApiManagementCustomDomain) Proxy() ApiManagementCustomDomainProxyList {
	var returns ApiManagementCustomDomainProxyList
	_jsii_.Get(
		j,
		"proxy",
		&returns,
...
func (j *jsiiProxy_ApiManagementCustomDomain) ProxyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"proxyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/api_management_custom_domain azurerm_api_management_custom_domain} Resource.
func NewApiManagementCustomDomain(scope constructs.Construct, id *string, config *ApiManagementCustomDomainConfig) ApiManagementCustomDomain {
	...
	if err := validateNewApiManagementCustomDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiManagementCustomDomain)SetCount(val interface{}) {
...
func ApiManagementCustomDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiManagementCustomDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ApiManagementCustomDomain_IsConstruct(x interface{}) *bool {
	...
	if err := validateApiManagementCustomDomain_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ApiManagementCustomDomain_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateApiManagementCustomDomain_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ApiManagementCustomDomain_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateApiManagementCustomDomain_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiManagementCustomDomain) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiManagementCustomDomain) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiManagementCustomDomain) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiManagementCustomDomain) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiManagementCustomDomain) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiManagementCustomDomain) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiManagementCustomDomain) PutProxy(value interface{}) {
...
func (a *jsiiProxy_ApiManagementCustomDomain) ResetProxy() {
	_jsii_.InvokeVoid(
		a,
		"resetProxy",
		nil, // no parameters
...
func (a *jsiiProxy_ApiManagementCustomDomain) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiManagementCustomDomain) ToHclTerraform() interface{} {
	var returns interface{}
