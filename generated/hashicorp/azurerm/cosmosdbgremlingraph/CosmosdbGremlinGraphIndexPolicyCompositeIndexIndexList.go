...
func NewCosmosdbGremlinGraphIndexPolicyCompositeIndexIndexList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbGremlinGraphIndexPolicyCompositeIndexIndexList {
	...
	if err := validateNewCosmosdbGremlinGraphIndexPolicyCompositeIndexIndexListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexIndexList{}

	_jsii_.Create(
		"azurerm.cosmosdbGremlinGraph.CosmosdbGremlinGraphIndexPolicyCompositeIndexIndexList",
...
func (c *jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexIndexList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
