...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_linked_service_kusto azurerm_data_factory_linked_service_kusto}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_linked_service_kusto azurerm_data_factory_linked_service_kusto} Resource.
func NewDataFactoryLinkedServiceKusto(scope constructs.Construct, id *string, config *DataFactoryLinkedServiceKustoConfig) DataFactoryLinkedServiceKusto {
	...
	_jsii_.Create(
		"azurerm.dataFactoryLinkedServiceKusto.DataFactoryLinkedServiceKusto",
...
func DataFactoryLinkedServiceKusto_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
