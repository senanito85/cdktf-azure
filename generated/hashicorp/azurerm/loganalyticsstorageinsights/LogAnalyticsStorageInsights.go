...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/log_analytics_storage_insights azurerm_log_analytics_storage_insights}.
...
func (j *jsiiProxy_LogAnalyticsStorageInsights) Tags() *map[string]*string {
...
func (j *jsiiProxy_LogAnalyticsStorageInsights) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/log_analytics_storage_insights azurerm_log_analytics_storage_insights} Resource.
...
func (j *jsiiProxy_LogAnalyticsStorageInsights)SetTags(val *map[string]*string) {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) ResetTags() {
	_jsii_.InvokeVoid(
		l,
		"resetTags",
		nil, // no parameters
