...
func init() {
	_jsii_.RegisterClass(
		"azurerm.logAnalyticsStorageInsights.LogAnalyticsStorageInsights",
		reflect.TypeOf((*LogAnalyticsStorageInsights)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "blobContainerNames", GoGetter: "BlobContainerNames"},
			_jsii_.MemberProperty{JsiiProperty: "blobContainerNamesInput", GoGetter: "BlobContainerNamesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBlobContainerNames", GoMethod: "ResetBlobContainerNames"},
	...
	_jsii_.RegisterStruct(
		"azurerm.logAnalyticsStorageInsights.LogAnalyticsStorageInsightsConfig",
		reflect.TypeOf((*LogAnalyticsStorageInsightsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.logAnalyticsStorageInsights.LogAnalyticsStorageInsightsTimeouts",
		reflect.TypeOf((*LogAnalyticsStorageInsightsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.logAnalyticsStorageInsights.LogAnalyticsStorageInsightsTimeoutsOutputReference",
