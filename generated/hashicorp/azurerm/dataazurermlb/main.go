...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermLb.DataAzurermLbFrontendIpConfiguration",
		reflect.TypeOf((*DataAzurermLbFrontendIpConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermLb.DataAzurermLbFrontendIpConfigurationList",
	...
	_jsii_.RegisterClass(
		"azurerm.dataAzurermLb.DataAzurermLbFrontendIpConfigurationOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermLb.DataAzurermLbTimeouts",
