...
func (j *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func NewHdinsightHadoopClusterGatewayOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightHadoopClusterGatewayOutputReference {
	...
	_jsii_.Create(
		"azurerm.hdinsightHadoopCluster.HdinsightHadoopClusterGatewayOutputReference",
...
func (j *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference)SetEnabled(val interface{}) {
...
func (h *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		h,
		"resetEnabled",
		nil, // no parameters
