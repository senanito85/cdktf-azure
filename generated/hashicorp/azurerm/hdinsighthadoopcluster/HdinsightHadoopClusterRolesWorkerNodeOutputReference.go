...
func (j *jsiiProxy_HdinsightHadoopClusterRolesWorkerNodeOutputReference) MinInstanceCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minInstanceCount",
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesWorkerNodeOutputReference) MinInstanceCountInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func NewHdinsightHadoopClusterRolesWorkerNodeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightHadoopClusterRolesWorkerNodeOutputReference {
	...
	_jsii_.Create(
		"azurerm.hdinsightHadoopCluster.HdinsightHadoopClusterRolesWorkerNodeOutputReference",
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesWorkerNodeOutputReference)SetMinInstanceCount(val *float64) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesWorkerNodeOutputReference) ResetMinInstanceCount() {
	_jsii_.InvokeVoid(
		h,
		"resetMinInstanceCount",
		nil, // no parameters
