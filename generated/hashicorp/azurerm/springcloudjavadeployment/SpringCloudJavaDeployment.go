...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/spring_cloud_java_deployment azurerm_spring_cloud_java_deployment}.
type SpringCloudJavaDeployment interface {
	...
	MemoryInGb() *float64
	SetMemoryInGb(val *float64)
	MemoryInGbInput() *float64
	Name() *string
	SetName(val *string)
	NameInput() *string
	// The tree node.
...
func (j *jsiiProxy_SpringCloudJavaDeployment) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SpringCloudJavaDeployment) Cpu() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"cpu",
...
func (j *jsiiProxy_SpringCloudJavaDeployment) CpuInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"cpuInput",
...
func (j *jsiiProxy_SpringCloudJavaDeployment) MemoryInGb() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"memoryInGb",
...
func (j *jsiiProxy_SpringCloudJavaDeployment) MemoryInGbInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"memoryInGbInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/spring_cloud_java_deployment azurerm_spring_cloud_java_deployment} Resource.
func NewSpringCloudJavaDeployment(scope constructs.Construct, id *string, config *SpringCloudJavaDeploymentConfig) SpringCloudJavaDeployment {
	...
	_jsii_.Create(
		"azurerm.springCloudJavaDeployment.SpringCloudJavaDeployment",
...
func (j *jsiiProxy_SpringCloudJavaDeployment)SetCount(val interface{}) {
...
func (j *jsiiProxy_SpringCloudJavaDeployment)SetCpu(val *float64) {
...
func (j *jsiiProxy_SpringCloudJavaDeployment)SetMemoryInGb(val *float64) {
	if err := j.validateSetMemoryInGbParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func SpringCloudJavaDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSpringCloudJavaDeployment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SpringCloudJavaDeployment) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpringCloudJavaDeployment) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudJavaDeployment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SpringCloudJavaDeployment) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpringCloudJavaDeployment) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SpringCloudJavaDeployment) MoveToId(id *string) {
...
func (s *jsiiProxy_SpringCloudJavaDeployment) ResetCpu() {
	_jsii_.InvokeVoid(
		s,
		"resetCpu",
		nil, // no parameters
...
func (s *jsiiProxy_SpringCloudJavaDeployment) ResetMemoryInGb() {
	_jsii_.InvokeVoid(
		s,
		"resetMemoryInGb",
		nil, // no parameters
...
func (s *jsiiProxy_SpringCloudJavaDeployment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SpringCloudJavaDeployment) ToHclTerraform() interface{} {
	var returns interface{}
