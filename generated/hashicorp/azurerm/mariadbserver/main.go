...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MariadbServer)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.mariadbServer.MariadbServerConfig",
		reflect.TypeOf((*MariadbServerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.mariadbServer.MariadbServerStorageProfile",
		reflect.TypeOf((*MariadbServerStorageProfile)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.mariadbServer.MariadbServerStorageProfileOutputReference",
		reflect.TypeOf((*MariadbServerStorageProfileOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.mariadbServer.MariadbServerTimeouts",
		reflect.TypeOf((*MariadbServerTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.mariadbServer.MariadbServerTimeoutsOutputReference",
		reflect.TypeOf((*MariadbServerTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
