...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermServicebusTopic.DataAzurermServicebusTopic",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermServicebusTopic.DataAzurermServicebusTopicTimeouts",
		reflect.TypeOf((*DataAzurermServicebusTopicTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermServicebusTopic.DataAzurermServicebusTopicTimeoutsOutputReference",
