...
func init() {
	_jsii_.RegisterClass(
		"azurerm.automationConnectionServicePrincipal.AutomationConnectionServicePrincipal",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "certificateThumbprintInput", GoGetter: "CertificateThumbprintInput"},
	...
	_jsii_.RegisterStruct(
		"azurerm.automationConnectionServicePrincipal.AutomationConnectionServicePrincipalConfig",
		reflect.TypeOf((*AutomationConnectionServicePrincipalConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.automationConnectionServicePrincipal.AutomationConnectionServicePrincipalTimeouts",
		reflect.TypeOf((*AutomationConnectionServicePrincipalTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.automationConnectionServicePrincipal.AutomationConnectionServicePrincipalTimeoutsOutputReference",
