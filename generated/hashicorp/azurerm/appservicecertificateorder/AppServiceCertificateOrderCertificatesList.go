...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/appservicecertificateorder/internal"
)
...
func NewAppServiceCertificateOrderCertificatesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppServiceCertificateOrderCertificatesList {
	...
	_jsii_.Create(
		"azurerm.appServiceCertificateOrder.AppServiceCertificateOrderCertificatesList",
...
func (a *jsiiProxy_AppServiceCertificateOrderCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
