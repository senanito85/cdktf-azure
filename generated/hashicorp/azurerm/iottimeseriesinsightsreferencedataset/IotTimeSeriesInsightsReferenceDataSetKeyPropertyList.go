...
func NewIotTimeSeriesInsightsReferenceDataSetKeyPropertyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IotTimeSeriesInsightsReferenceDataSetKeyPropertyList {
	...
	if err := validateNewIotTimeSeriesInsightsReferenceDataSetKeyPropertyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotTimeSeriesInsightsReferenceDataSetKeyPropertyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
