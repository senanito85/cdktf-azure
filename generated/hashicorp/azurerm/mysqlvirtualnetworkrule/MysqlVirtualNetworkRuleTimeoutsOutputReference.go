...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/mysqlvirtualnetworkrule/internal"
)
...
func NewMysqlVirtualNetworkRuleTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MysqlVirtualNetworkRuleTimeoutsOutputReference {
	...
	if err := validateNewMysqlVirtualNetworkRuleTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
