...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/datafactorylinkedservicekeyvault/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_linked_service_key_vault azurerm_data_factory_linked_service_key_vault}.
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) DataFactoryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataFactoryName",
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) DataFactoryNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_linked_service_key_vault azurerm_data_factory_linked_service_key_vault} Resource.
func NewDataFactoryLinkedServiceKeyVault(scope constructs.Construct, id *string, config *DataFactoryLinkedServiceKeyVaultConfig) DataFactoryLinkedServiceKeyVault {
	...
	if err := validateNewDataFactoryLinkedServiceKeyVaultParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryLinkedServiceKeyVault{}

	_jsii_.Create(
		"azurerm.dataFactoryLinkedServiceKeyVault.DataFactoryLinkedServiceKeyVault",
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault)SetDataFactoryName(val *string) {
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault)SetResourceGroupName(val *string) {
...
func DataFactoryLinkedServiceKeyVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataFactoryLinkedServiceKeyVault_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataFactoryLinkedServiceKeyVault_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataFactoryLinkedServiceKeyVault_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryLinkedServiceKeyVault_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryLinkedServiceKeyVault_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryLinkedServiceKeyVault_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryLinkedServiceKeyVault_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) ResetDataFactoryId() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryId",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) ResetDataFactoryName() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryName",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) ToHclTerraform() interface{} {
	var returns interface{}
