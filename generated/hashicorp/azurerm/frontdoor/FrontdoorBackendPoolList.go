...
func NewFrontdoorBackendPoolList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorBackendPoolList {
	...
	if err := validateNewFrontdoorBackendPoolListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FrontdoorBackendPoolList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
