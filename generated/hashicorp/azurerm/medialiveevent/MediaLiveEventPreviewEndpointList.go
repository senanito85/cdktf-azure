...
func NewMediaLiveEventPreviewEndpointList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaLiveEventPreviewEndpointList {
	...
	_jsii_.Create(
		"azurerm.mediaLiveEvent.MediaLiveEventPreviewEndpointList",
...
func (m *jsiiProxy_MediaLiveEventPreviewEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
