...
func NewMediaLiveEventInputIpAccessControlAllowList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaLiveEventInputIpAccessControlAllowList {
	...
	if err := validateNewMediaLiveEventInputIpAccessControlAllowListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MediaLiveEventInputIpAccessControlAllowList{}

	_jsii_.Create(
		"azurerm.mediaLiveEvent.MediaLiveEventInputIpAccessControlAllowList",
...
func (m *jsiiProxy_MediaLiveEventInputIpAccessControlAllowList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
