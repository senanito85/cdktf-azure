...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.sentinelDataConnectorThreatIntelligence.SentinelDataConnectorThreatIntelligenceConfig",
		reflect.TypeOf((*SentinelDataConnectorThreatIntelligenceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.sentinelDataConnectorThreatIntelligence.SentinelDataConnectorThreatIntelligenceTimeouts",
		reflect.TypeOf((*SentinelDataConnectorThreatIntelligenceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.sentinelDataConnectorThreatIntelligence.SentinelDataConnectorThreatIntelligenceTimeoutsOutputReference",
