...
func init() {
	_jsii_.RegisterClass(
		"azurerm.virtualHubIp.VirtualHubIp",
	...
	_jsii_.RegisterStruct(
		"azurerm.virtualHubIp.VirtualHubIpConfig",
		reflect.TypeOf((*VirtualHubIpConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.virtualHubIp.VirtualHubIpTimeouts",
		reflect.TypeOf((*VirtualHubIpTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.virtualHubIp.VirtualHubIpTimeoutsOutputReference",
