...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/loganalyticscluster/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/log_analytics_cluster azurerm_log_analytics_cluster}.
...
func (j *jsiiProxy_LogAnalyticsCluster) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LogAnalyticsCluster) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LogAnalyticsCluster) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogAnalyticsCluster) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_LogAnalyticsCluster) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/log_analytics_cluster azurerm_log_analytics_cluster} Resource.
func NewLogAnalyticsCluster(scope constructs.Construct, id *string, config *LogAnalyticsClusterConfig) LogAnalyticsCluster {
	...
	_jsii_.Create(
		"azurerm.logAnalyticsCluster.LogAnalyticsCluster",
...
func (j *jsiiProxy_LogAnalyticsCluster)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogAnalyticsCluster)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogAnalyticsCluster)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LogAnalyticsCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LogAnalyticsCluster) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LogAnalyticsCluster) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
