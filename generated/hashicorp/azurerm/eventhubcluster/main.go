...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.eventhubCluster.EventhubClusterConfig",
		reflect.TypeOf((*EventhubClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.eventhubCluster.EventhubClusterTimeouts",
		reflect.TypeOf((*EventhubClusterTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.eventhubCluster.EventhubClusterTimeoutsOutputReference",
