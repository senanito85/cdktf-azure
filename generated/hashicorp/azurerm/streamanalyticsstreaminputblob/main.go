...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.streamAnalyticsStreamInputBlob.StreamAnalyticsStreamInputBlobConfig",
	...
	_jsii_.RegisterStruct(
		"azurerm.streamAnalyticsStreamInputBlob.StreamAnalyticsStreamInputBlobTimeouts",
