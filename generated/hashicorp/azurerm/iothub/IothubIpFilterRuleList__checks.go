...
func (j *jsiiProxy_IothubIpFilterRuleList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*IothubIpFilterRule:
		val := val.(*[]*IothubIpFilterRule)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*IothubIpFilterRule; received %#v (a %T)", val, val)
		}
	}
