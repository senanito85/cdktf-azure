...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/dataazurermdataprotectionbackupvault/internal"
)
...
func NewDataAzurermDataProtectionBackupVaultTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermDataProtectionBackupVaultTimeoutsOutputReference {
	...
	if err := validateNewDataAzurermDataProtectionBackupVaultTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermDataProtectionBackupVaultTimeoutsOutputReference{}

	_jsii_.Create(
		"azurerm.dataAzurermDataProtectionBackupVault.DataAzurermDataProtectionBackupVaultTimeoutsOutputReference",
