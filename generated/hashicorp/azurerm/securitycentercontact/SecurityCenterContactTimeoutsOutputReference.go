...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/securitycentercontact/internal"
)
...
func NewSecurityCenterContactTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SecurityCenterContactTimeoutsOutputReference {
	...
	if err := validateNewSecurityCenterContactTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
