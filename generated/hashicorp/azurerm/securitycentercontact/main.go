...
func init() {
	_jsii_.RegisterClass(
		"azurerm.securityCenterContact.SecurityCenterContact",
		reflect.TypeOf((*SecurityCenterContact)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "alertNotifications", GoGetter: "AlertNotifications"},
			_jsii_.MemberProperty{JsiiProperty: "alertNotificationsInput", GoGetter: "AlertNotificationsInput"},
			_jsii_.MemberProperty{JsiiProperty: "alertsToAdmins", GoGetter: "AlertsToAdmins"},
			_jsii_.MemberProperty{JsiiProperty: "alertsToAdminsInput", GoGetter: "AlertsToAdminsInput"},
	...
	_jsii_.RegisterStruct(
		"azurerm.securityCenterContact.SecurityCenterContactConfig",
		reflect.TypeOf((*SecurityCenterContactConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.securityCenterContact.SecurityCenterContactTimeouts",
		reflect.TypeOf((*SecurityCenterContactTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.securityCenterContact.SecurityCenterContactTimeoutsOutputReference",
