...
func NewApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList {
	...
	if err := validateNewApiManagementDiagnosticBackendRequestDataMaskingQueryParamsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
