...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.attestationProvider.AttestationProviderConfig",
		reflect.TypeOf((*AttestationProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.attestationProvider.AttestationProviderTimeouts",
		reflect.TypeOf((*AttestationProviderTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.attestationProvider.AttestationProviderTimeoutsOutputReference",
