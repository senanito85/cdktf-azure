...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermPostgresqlServer.DataAzurermPostgresqlServerConfig",
		reflect.TypeOf((*DataAzurermPostgresqlServerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermPostgresqlServer.DataAzurermPostgresqlServerIdentity",
		reflect.TypeOf((*DataAzurermPostgresqlServerIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermPostgresqlServer.DataAzurermPostgresqlServerIdentityList",
	...
	_jsii_.RegisterClass(
		"azurerm.dataAzurermPostgresqlServer.DataAzurermPostgresqlServerIdentityOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermPostgresqlServer.DataAzurermPostgresqlServerTimeouts",
