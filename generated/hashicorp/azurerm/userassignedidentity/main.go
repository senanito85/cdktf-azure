...
func init() {
	_jsii_.RegisterClass(
		"azurerm.userAssignedIdentity.UserAssignedIdentity",
	...
	_jsii_.RegisterStruct(
		"azurerm.userAssignedIdentity.UserAssignedIdentityConfig",
		reflect.TypeOf((*UserAssignedIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.userAssignedIdentity.UserAssignedIdentityTimeouts",
		reflect.TypeOf((*UserAssignedIdentityTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.userAssignedIdentity.UserAssignedIdentityTimeoutsOutputReference",
		...
		func() interface{} {
			j := jsiiProxy_UserAssignedIdentityTimeoutsOutputReference{}
