...
func (j *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference)SetEnabled(val interface{}) {
...
func (h *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		h,
		"resetEnabled",
		nil, // no parameters
