...
func NewMediaContentKeyPolicyPolicyOptionTokenRestrictionRequiredClaimList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaContentKeyPolicyPolicyOptionTokenRestrictionRequiredClaimList {
	...
	if err := validateNewMediaContentKeyPolicyPolicyOptionTokenRestrictionRequiredClaimListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MediaContentKeyPolicyPolicyOptionTokenRestrictionRequiredClaimList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
