...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/media_content_key_policy azurerm_media_content_key_policy}.
...
func (j *jsiiProxy_MediaContentKeyPolicy) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/media_content_key_policy azurerm_media_content_key_policy} Resource.
func NewMediaContentKeyPolicy(scope constructs.Construct, id *string, config *MediaContentKeyPolicyConfig) MediaContentKeyPolicy {
	...
	if err := validateNewMediaContentKeyPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MediaContentKeyPolicy)SetCount(val interface{}) {
...
func MediaContentKeyPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMediaContentKeyPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MediaContentKeyPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateMediaContentKeyPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MediaContentKeyPolicy_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateMediaContentKeyPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MediaContentKeyPolicy_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateMediaContentKeyPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MediaContentKeyPolicy) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MediaContentKeyPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MediaContentKeyPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MediaContentKeyPolicy) MoveFromId(id *string) {
...
func (m *jsiiProxy_MediaContentKeyPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MediaContentKeyPolicy) MoveToId(id *string) {
...
func (m *jsiiProxy_MediaContentKeyPolicy) PutPolicyOption(value interface{}) {
	if err := m.validatePutPolicyOptionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MediaContentKeyPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MediaContentKeyPolicy) ToHclTerraform() interface{} {
	var returns interface{}
