...
func init() {
	_jsii_.RegisterClass(
		"azurerm.sentinelAlertRuleFusion.SentinelAlertRuleFusion",
	...
	_jsii_.RegisterStruct(
		"azurerm.sentinelAlertRuleFusion.SentinelAlertRuleFusionConfig",
		reflect.TypeOf((*SentinelAlertRuleFusionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.sentinelAlertRuleFusion.SentinelAlertRuleFusionTimeouts",
		reflect.TypeOf((*SentinelAlertRuleFusionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.sentinelAlertRuleFusion.SentinelAlertRuleFusionTimeoutsOutputReference",
