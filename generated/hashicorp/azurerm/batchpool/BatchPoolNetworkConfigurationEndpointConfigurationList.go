...
func NewBatchPoolNetworkConfigurationEndpointConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolNetworkConfigurationEndpointConfigurationList {
	...
	_jsii_.Create(
		"azurerm.batchPool.BatchPoolNetworkConfigurationEndpointConfigurationList",
...
func (b *jsiiProxy_BatchPoolNetworkConfigurationEndpointConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
