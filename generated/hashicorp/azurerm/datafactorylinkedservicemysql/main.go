...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataFactoryLinkedServiceMysql)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.dataFactoryLinkedServiceMysql.DataFactoryLinkedServiceMysqlConfig",
		reflect.TypeOf((*DataFactoryLinkedServiceMysqlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataFactoryLinkedServiceMysql.DataFactoryLinkedServiceMysqlTimeouts",
		reflect.TypeOf((*DataFactoryLinkedServiceMysqlTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataFactoryLinkedServiceMysql.DataFactoryLinkedServiceMysqlTimeoutsOutputReference",
		reflect.TypeOf((*DataFactoryLinkedServiceMysqlTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
