...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermServicebusTopicAuthorizationRule.DataAzurermServicebusTopicAuthorizationRuleConfig",
		reflect.TypeOf((*DataAzurermServicebusTopicAuthorizationRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermServicebusTopicAuthorizationRule.DataAzurermServicebusTopicAuthorizationRuleTimeouts",
