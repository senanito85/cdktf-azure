...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.securityCenterSubscriptionPricing.SecurityCenterSubscriptionPricingConfig",
		reflect.TypeOf((*SecurityCenterSubscriptionPricingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.securityCenterSubscriptionPricing.SecurityCenterSubscriptionPricingTimeouts",
