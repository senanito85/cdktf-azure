...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/publicip/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/public_ip azurerm_public_ip}.
...
func (j *jsiiProxy_PublicIp) AvailabilityZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"availabilityZone",
...
func (j *jsiiProxy_PublicIp) AvailabilityZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/public_ip azurerm_public_ip} Resource.
...
func (j *jsiiProxy_PublicIp)SetAvailabilityZone(val *string) {
...
func (p *jsiiProxy_PublicIp) ResetAvailabilityZone() {
	_jsii_.InvokeVoid(
		p,
		"resetAvailabilityZone",
		nil, // no parameters
