...
func (j *jsiiProxy_SqlDatabaseThreatDetectionPolicyOutputReference) UseServerDefault() *string {
	var returns *string
	_jsii_.Get(
		j,
		"useServerDefault",
...
func (j *jsiiProxy_SqlDatabaseThreatDetectionPolicyOutputReference) UseServerDefaultInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlDatabaseThreatDetectionPolicyOutputReference)SetUseServerDefault(val *string) {
...
func (s *jsiiProxy_SqlDatabaseThreatDetectionPolicyOutputReference) ResetUseServerDefault() {
	_jsii_.InvokeVoid(
		s,
		"resetUseServerDefault",
		nil, // no parameters
