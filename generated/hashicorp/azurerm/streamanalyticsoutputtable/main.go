...
func init() {
	_jsii_.RegisterClass(
		"azurerm.streamAnalyticsOutputTable.StreamAnalyticsOutputTable",
	...
	_jsii_.RegisterStruct(
		"azurerm.streamAnalyticsOutputTable.StreamAnalyticsOutputTableConfig",
		reflect.TypeOf((*StreamAnalyticsOutputTableConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.streamAnalyticsOutputTable.StreamAnalyticsOutputTableTimeouts",
