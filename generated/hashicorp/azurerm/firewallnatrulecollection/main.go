...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.firewallNatRuleCollection.FirewallNatRuleCollectionConfig",
	...
	_jsii_.RegisterStruct(
		"azurerm.firewallNatRuleCollection.FirewallNatRuleCollectionTimeouts",
		reflect.TypeOf((*FirewallNatRuleCollectionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.firewallNatRuleCollection.FirewallNatRuleCollectionTimeoutsOutputReference",
