...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.monitorDiagnosticSetting.MonitorDiagnosticSettingLog",
		reflect.TypeOf((*MonitorDiagnosticSettingLog)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.monitorDiagnosticSetting.MonitorDiagnosticSettingLogList",
	...
	_jsii_.RegisterStruct(
		"azurerm.monitorDiagnosticSetting.MonitorDiagnosticSettingLogRetentionPolicy",
		reflect.TypeOf((*MonitorDiagnosticSettingLogRetentionPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.monitorDiagnosticSetting.MonitorDiagnosticSettingLogRetentionPolicyOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.monitorDiagnosticSetting.MonitorDiagnosticSettingMetric",
		reflect.TypeOf((*MonitorDiagnosticSettingMetric)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.monitorDiagnosticSetting.MonitorDiagnosticSettingMetricList",
	...
	_jsii_.RegisterClass(
		"azurerm.monitorDiagnosticSetting.MonitorDiagnosticSettingMetricOutputReference",
	...
	_jsii_.RegisterClass(
		"azurerm.monitorDiagnosticSetting.MonitorDiagnosticSettingMetricRetentionPolicyOutputReference",
