...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermPostgresqlFlexibleServer.DataAzurermPostgresqlFlexibleServerConfig",
		reflect.TypeOf((*DataAzurermPostgresqlFlexibleServerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermPostgresqlFlexibleServer.DataAzurermPostgresqlFlexibleServerTimeouts",
		reflect.TypeOf((*DataAzurermPostgresqlFlexibleServerTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermPostgresqlFlexibleServer.DataAzurermPostgresqlFlexibleServerTimeoutsOutputReference",
