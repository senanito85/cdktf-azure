...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_dataset_binary azurerm_data_factory_dataset_binary}.
...
func (j *jsiiProxy_DataFactoryDatasetBinary) DataFactoryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataFactoryName",
...
func (j *jsiiProxy_DataFactoryDatasetBinary) DataFactoryNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataFactoryDatasetBinary) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_DataFactoryDatasetBinary) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_dataset_binary azurerm_data_factory_dataset_binary} Resource.
func NewDataFactoryDatasetBinary(scope constructs.Construct, id *string, config *DataFactoryDatasetBinaryConfig) DataFactoryDatasetBinary {
	...
	_jsii_.Create(
		"azurerm.dataFactoryDatasetBinary.DataFactoryDatasetBinary",
...
func (j *jsiiProxy_DataFactoryDatasetBinary)SetDataFactoryName(val *string) {
...
func (j *jsiiProxy_DataFactoryDatasetBinary)SetResourceGroupName(val *string) {
...
func (d *jsiiProxy_DataFactoryDatasetBinary) ResetDataFactoryId() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryId",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryDatasetBinary) ResetDataFactoryName() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryName",
		nil, // no parameters
