...
func (j *jsiiProxy_HdinsightHbaseClusterGatewayOutputReference) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_HdinsightHbaseClusterGatewayOutputReference) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_HdinsightHbaseClusterGatewayOutputReference)SetEnabled(val interface{}) {
...
func (h *jsiiProxy_HdinsightHbaseClusterGatewayOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		h,
		"resetEnabled",
		nil, // no parameters
