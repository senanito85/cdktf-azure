...
func NewAppConfigurationFeatureTargetingFilterGroupsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppConfigurationFeatureTargetingFilterGroupsList {
	...
	if err := validateNewAppConfigurationFeatureTargetingFilterGroupsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsList{}

	_jsii_.Create(
		"azurerm.appConfigurationFeature.AppConfigurationFeatureTargetingFilterGroupsList",
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
