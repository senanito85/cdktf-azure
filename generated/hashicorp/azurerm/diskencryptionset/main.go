...
func init() {
	_jsii_.RegisterClass(
		"azurerm.diskEncryptionSet.DiskEncryptionSet",
		reflect.TypeOf((*DiskEncryptionSet)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "autoKeyRotationEnabled", GoGetter: "AutoKeyRotationEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "autoKeyRotationEnabledInput", GoGetter: "AutoKeyRotationEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoKeyRotationEnabled", GoMethod: "ResetAutoKeyRotationEnabled"},
	...
	_jsii_.RegisterStruct(
		"azurerm.diskEncryptionSet.DiskEncryptionSetConfig",
		reflect.TypeOf((*DiskEncryptionSetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.diskEncryptionSet.DiskEncryptionSetIdentity",
		reflect.TypeOf((*DiskEncryptionSetIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.diskEncryptionSet.DiskEncryptionSetIdentityOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.diskEncryptionSet.DiskEncryptionSetTimeouts",
		reflect.TypeOf((*DiskEncryptionSetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.diskEncryptionSet.DiskEncryptionSetTimeoutsOutputReference",
