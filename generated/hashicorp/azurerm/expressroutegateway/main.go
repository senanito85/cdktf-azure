...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.expressRouteGateway.ExpressRouteGatewayConfig",
		reflect.TypeOf((*ExpressRouteGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.expressRouteGateway.ExpressRouteGatewayTimeouts",
		reflect.TypeOf((*ExpressRouteGatewayTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.expressRouteGateway.ExpressRouteGatewayTimeoutsOutputReference",
