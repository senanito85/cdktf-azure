...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolume",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeConfig",
	...
	_jsii_.RegisterClass(
		"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeDataProtectionReplicationList",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeTimeouts",
		reflect.TypeOf((*DataAzurermNetappVolumeTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeTimeoutsOutputReference",
