...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_dataset_mysql azurerm_data_factory_dataset_mysql}.
...
func (j *jsiiProxy_DataFactoryDatasetMysql) DataFactoryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataFactoryName",
...
func (j *jsiiProxy_DataFactoryDatasetMysql) DataFactoryNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataFactoryDatasetMysql) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_DataFactoryDatasetMysql) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_dataset_mysql azurerm_data_factory_dataset_mysql} Resource.
...
func (j *jsiiProxy_DataFactoryDatasetMysql)SetDataFactoryName(val *string) {
...
func (j *jsiiProxy_DataFactoryDatasetMysql)SetResourceGroupName(val *string) {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) ResetDataFactoryId() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryId",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryDatasetMysql) ResetDataFactoryName() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryName",
		nil, // no parameters
