...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/datafactorydatasetmysql/internal"
)
...
func NewDataFactoryDatasetMysqlSchemaColumnOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataFactoryDatasetMysqlSchemaColumnOutputReference {
	...
	if err := validateNewDataFactoryDatasetMysqlSchemaColumnOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryDatasetMysqlSchemaColumnOutputReference{}

	_jsii_.Create(
		"azurerm.dataFactoryDatasetMysql.DataFactoryDatasetMysqlSchemaColumnOutputReference",
