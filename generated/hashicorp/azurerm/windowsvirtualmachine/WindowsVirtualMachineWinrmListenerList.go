...
func NewWindowsVirtualMachineWinrmListenerList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineWinrmListenerList {
	...
	if err := validateNewWindowsVirtualMachineWinrmListenerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsVirtualMachineWinrmListenerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
