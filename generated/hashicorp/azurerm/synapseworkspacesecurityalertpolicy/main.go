...
func init() {
	_jsii_.RegisterClass(
		"azurerm.synapseWorkspaceSecurityAlertPolicy.SynapseWorkspaceSecurityAlertPolicy",
		reflect.TypeOf((*SynapseWorkspaceSecurityAlertPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"azurerm.synapseWorkspaceSecurityAlertPolicy.SynapseWorkspaceSecurityAlertPolicyConfig",
		reflect.TypeOf((*SynapseWorkspaceSecurityAlertPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.synapseWorkspaceSecurityAlertPolicy.SynapseWorkspaceSecurityAlertPolicyTimeouts",
		reflect.TypeOf((*SynapseWorkspaceSecurityAlertPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.synapseWorkspaceSecurityAlertPolicy.SynapseWorkspaceSecurityAlertPolicyTimeoutsOutputReference",
		reflect.TypeOf((*SynapseWorkspaceSecurityAlertPolicyTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
