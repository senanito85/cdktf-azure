...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/policy_virtual_machine_configuration_assignment azurerm_policy_virtual_machine_configuration_assignment}.
...
func (j *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/policy_virtual_machine_configuration_assignment azurerm_policy_virtual_machine_configuration_assignment} Resource.
func NewPolicyVirtualMachineConfigurationAssignment(scope constructs.Construct, id *string, config *PolicyVirtualMachineConfigurationAssignmentConfig) PolicyVirtualMachineConfigurationAssignment {
	...
	_jsii_.Create(
		"azurerm.policyVirtualMachineConfigurationAssignment.PolicyVirtualMachineConfigurationAssignment",
...
func (j *jsiiProxy_PolicyVirtualMachineConfigurationAssignment)SetCount(val interface{}) {
...
func PolicyVirtualMachineConfigurationAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePolicyVirtualMachineConfigurationAssignment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) MoveFromId(id *string) {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) MoveToId(id *string) {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignment) ToHclTerraform() interface{} {
	var returns interface{}
