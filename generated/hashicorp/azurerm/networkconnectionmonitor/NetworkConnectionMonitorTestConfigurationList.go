...
func NewNetworkConnectionMonitorTestConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkConnectionMonitorTestConfigurationList {
	...
	if err := validateNewNetworkConnectionMonitorTestConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_NetworkConnectionMonitorTestConfigurationList{}

	_jsii_.Create(
		"azurerm.networkConnectionMonitor.NetworkConnectionMonitorTestConfigurationList",
...
func (n *jsiiProxy_NetworkConnectionMonitorTestConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
