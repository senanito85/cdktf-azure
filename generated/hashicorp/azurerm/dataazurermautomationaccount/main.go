...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermAutomationAccount.DataAzurermAutomationAccount",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermAutomationAccount.DataAzurermAutomationAccountConfig",
		reflect.TypeOf((*DataAzurermAutomationAccountConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermAutomationAccount.DataAzurermAutomationAccountTimeouts",
