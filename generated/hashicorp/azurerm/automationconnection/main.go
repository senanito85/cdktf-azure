...
func init() {
	_jsii_.RegisterClass(
		"azurerm.automationConnection.AutomationConnection",
	...
	_jsii_.RegisterStruct(
		"azurerm.automationConnection.AutomationConnectionConfig",
		reflect.TypeOf((*AutomationConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.automationConnection.AutomationConnectionTimeouts",
		reflect.TypeOf((*AutomationConnectionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.automationConnection.AutomationConnectionTimeoutsOutputReference",
