...
func init() {
	_jsii_.RegisterClass(
		"azurerm.mssqlJobCredential.MssqlJobCredential",
	...
	_jsii_.RegisterStruct(
		"azurerm.mssqlJobCredential.MssqlJobCredentialConfig",
		reflect.TypeOf((*MssqlJobCredentialConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.mssqlJobCredential.MssqlJobCredentialTimeouts",
		reflect.TypeOf((*MssqlJobCredentialTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.mssqlJobCredential.MssqlJobCredentialTimeoutsOutputReference",
