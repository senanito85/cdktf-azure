...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/mssql_job_credential azurerm_mssql_job_credential}.
...
func (j *jsiiProxy_MssqlJobCredential) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/mssql_job_credential azurerm_mssql_job_credential} Resource.
func NewMssqlJobCredential(scope constructs.Construct, id *string, config *MssqlJobCredentialConfig) MssqlJobCredential {
	_init_.Initialize()

	if err := validateNewMssqlJobCredentialParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MssqlJobCredential)SetCount(val interface{}) {
...
func (j *jsiiProxy_MssqlJobCredential)SetJobAgentId(val *string) {
	if err := j.validateSetJobAgentIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func MssqlJobCredential_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMssqlJobCredential_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MssqlJobCredential_IsConstruct(x interface{}) *bool {
	...
	if err := validateMssqlJobCredential_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MssqlJobCredential_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMssqlJobCredential_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MssqlJobCredential_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMssqlJobCredential_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MssqlJobCredential) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MssqlJobCredential) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MssqlJobCredential) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MssqlJobCredential) MoveFromId(id *string) {
...
func (m *jsiiProxy_MssqlJobCredential) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MssqlJobCredential) MoveToId(id *string) {
...
func (m *jsiiProxy_MssqlJobCredential) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MssqlJobCredential) ToHclTerraform() interface{} {
	var returns interface{}
