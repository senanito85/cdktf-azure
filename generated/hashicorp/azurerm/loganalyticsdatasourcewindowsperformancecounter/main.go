...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogAnalyticsDatasourceWindowsPerformanceCounter)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "counterName", GoGetter: "CounterName"},
			_jsii_.MemberProperty{JsiiProperty: "counterNameInput", GoGetter: "CounterNameInput"},
	...
	_jsii_.RegisterStruct(
		"azurerm.logAnalyticsDatasourceWindowsPerformanceCounter.LogAnalyticsDatasourceWindowsPerformanceCounterConfig",
		reflect.TypeOf((*LogAnalyticsDatasourceWindowsPerformanceCounterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.logAnalyticsDatasourceWindowsPerformanceCounter.LogAnalyticsDatasourceWindowsPerformanceCounterTimeouts",
		reflect.TypeOf((*LogAnalyticsDatasourceWindowsPerformanceCounterTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.logAnalyticsDatasourceWindowsPerformanceCounter.LogAnalyticsDatasourceWindowsPerformanceCounterTimeoutsOutputReference",
		reflect.TypeOf((*LogAnalyticsDatasourceWindowsPerformanceCounterTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
