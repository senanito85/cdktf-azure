...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.dnsSrvRecord.DnsSrvRecordConfig",
		reflect.TypeOf((*DnsSrvRecordConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dnsSrvRecord.DnsSrvRecordRecord",
		reflect.TypeOf((*DnsSrvRecordRecord)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dnsSrvRecord.DnsSrvRecordRecordList",
	...
	_jsii_.RegisterClass(
		"azurerm.dnsSrvRecord.DnsSrvRecordRecordOutputReference",
	...
	_jsii_.RegisterStruct(
		"azurerm.dnsSrvRecord.DnsSrvRecordTimeouts",
