...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.eventhubConsumerGroup.EventhubConsumerGroupConfig",
		reflect.TypeOf((*EventhubConsumerGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.eventhubConsumerGroup.EventhubConsumerGroupTimeouts",
		reflect.TypeOf((*EventhubConsumerGroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.eventhubConsumerGroup.EventhubConsumerGroupTimeoutsOutputReference",
