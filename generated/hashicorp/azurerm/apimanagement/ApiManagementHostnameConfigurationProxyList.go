...
func NewApiManagementHostnameConfigurationProxyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementHostnameConfigurationProxyList {
	...
	if err := validateNewApiManagementHostnameConfigurationProxyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationProxyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
