...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/logic_app_trigger_recurrence azurerm_logic_app_trigger_recurrence}.
...
func (j *jsiiProxy_LogicAppTriggerRecurrence) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/logic_app_trigger_recurrence azurerm_logic_app_trigger_recurrence} Resource.
func NewLogicAppTriggerRecurrence(scope constructs.Construct, id *string, config *LogicAppTriggerRecurrenceConfig) LogicAppTriggerRecurrence {
	...
	if err := validateNewLogicAppTriggerRecurrenceParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_LogicAppTriggerRecurrence{}

	_jsii_.Create(
		"azurerm.logicAppTriggerRecurrence.LogicAppTriggerRecurrence",
...
func (j *jsiiProxy_LogicAppTriggerRecurrence)SetCount(val interface{}) {
...
func LogicAppTriggerRecurrence_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLogicAppTriggerRecurrence_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LogicAppTriggerRecurrence_IsConstruct(x interface{}) *bool {
	...
	if err := validateLogicAppTriggerRecurrence_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LogicAppTriggerRecurrence_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLogicAppTriggerRecurrence_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LogicAppTriggerRecurrence_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLogicAppTriggerRecurrence_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LogicAppTriggerRecurrence) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LogicAppTriggerRecurrence) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogicAppTriggerRecurrence) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LogicAppTriggerRecurrence) MoveFromId(id *string) {
...
func (l *jsiiProxy_LogicAppTriggerRecurrence) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LogicAppTriggerRecurrence) MoveToId(id *string) {
...
func (l *jsiiProxy_LogicAppTriggerRecurrence) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LogicAppTriggerRecurrence) ToHclTerraform() interface{} {
	var returns interface{}
