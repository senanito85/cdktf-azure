...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataAzurermMapsAccount.DataAzurermMapsAccount",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermMapsAccount.DataAzurermMapsAccountConfig",
		reflect.TypeOf((*DataAzurermMapsAccountConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataAzurermMapsAccount.DataAzurermMapsAccountTimeouts",
