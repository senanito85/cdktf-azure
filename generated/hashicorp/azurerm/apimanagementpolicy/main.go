...
func init() {
	_jsii_.RegisterClass(
		"azurerm.apiManagementPolicy.ApiManagementPolicyA",
	...
	_jsii_.RegisterStruct(
		"azurerm.apiManagementPolicy.ApiManagementPolicyAConfig",
		reflect.TypeOf((*ApiManagementPolicyAConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.apiManagementPolicy.ApiManagementPolicyTimeouts",
