...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleConfig",
	...
	_jsii_.RegisterClass(
		"azurerm.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleTimeoutsOutputReference",
