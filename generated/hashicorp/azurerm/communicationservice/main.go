...
func init() {
	_jsii_.RegisterClass(
		"azurerm.communicationService.CommunicationService",
	...
	_jsii_.RegisterStruct(
		"azurerm.communicationService.CommunicationServiceConfig",
		reflect.TypeOf((*CommunicationServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.communicationService.CommunicationServiceTimeouts",
