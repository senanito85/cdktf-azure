...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_dataset_snowflake azurerm_data_factory_dataset_snowflake}.
type DataFactoryDatasetSnowflake interface {
	...
	StructureColumn() DataFactoryDatasetSnowflakeStructureColumnList
	StructureColumnInput() interface{}
	TableName() *string
	...
	PutStructureColumn(value interface{})
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) DataFactoryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataFactoryName",
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) DataFactoryNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) StructureColumn() DataFactoryDatasetSnowflakeStructureColumnList {
	var returns DataFactoryDatasetSnowflakeStructureColumnList
	_jsii_.Get(
		j,
		"structureColumn",
		&returns,
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) StructureColumnInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"structureColumnInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/data_factory_dataset_snowflake azurerm_data_factory_dataset_snowflake} Resource.
func NewDataFactoryDatasetSnowflake(scope constructs.Construct, id *string, config *DataFactoryDatasetSnowflakeConfig) DataFactoryDatasetSnowflake {
	...
	_jsii_.Create(
		"azurerm.dataFactoryDatasetSnowflake.DataFactoryDatasetSnowflake",
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake)SetDataFactoryName(val *string) {
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake)SetResourceGroupName(val *string) {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) PutStructureColumn(value interface{}) {
	if err := d.validatePutStructureColumnParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) ResetDataFactoryId() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryId",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) ResetDataFactoryName() {
	_jsii_.InvokeVoid(
		d,
		"resetDataFactoryName",
		nil, // no parameters
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) ResetStructureColumn() {
	_jsii_.InvokeVoid(
		d,
		"resetStructureColumn",
		nil, // no parameters
