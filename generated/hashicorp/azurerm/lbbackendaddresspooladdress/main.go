...
func init() {
	...
	_jsii_.RegisterStruct(
		"azurerm.lbBackendAddressPoolAddress.LbBackendAddressPoolAddressConfig",
		reflect.TypeOf((*LbBackendAddressPoolAddressConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.lbBackendAddressPoolAddress.LbBackendAddressPoolAddressTimeouts",
		reflect.TypeOf((*LbBackendAddressPoolAddressTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.lbBackendAddressPoolAddress.LbBackendAddressPoolAddressTimeoutsOutputReference",
