...
func init() {
	_jsii_.RegisterClass(
		"azurerm.dataProtectionBackupPolicyBlobStorage.DataProtectionBackupPolicyBlobStorage",
	...
	_jsii_.RegisterStruct(
		"azurerm.dataProtectionBackupPolicyBlobStorage.DataProtectionBackupPolicyBlobStorageConfig",
		reflect.TypeOf((*DataProtectionBackupPolicyBlobStorageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"azurerm.dataProtectionBackupPolicyBlobStorage.DataProtectionBackupPolicyBlobStorageTimeouts",
		reflect.TypeOf((*DataProtectionBackupPolicyBlobStorageTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"azurerm.dataProtectionBackupPolicyBlobStorage.DataProtectionBackupPolicyBlobStorageTimeoutsOutputReference",
