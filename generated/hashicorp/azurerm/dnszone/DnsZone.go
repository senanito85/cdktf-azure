...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/dns_zone azurerm_dns_zone}.
type DnsZone interface {
	...
	SoaRecord() DnsZoneSoaRecordOutputReference
	SoaRecordInput() *DnsZoneSoaRecord
	...
	PutSoaRecord(value *DnsZoneSoaRecord)
...
func (j *jsiiProxy_DnsZone) MaxNumberOfRecordSets() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DnsZone) NumberOfRecordSets() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"numberOfRecordSets",
...
func (j *jsiiProxy_DnsZone) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_DnsZone) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DnsZone) SoaRecord() DnsZoneSoaRecordOutputReference {
	var returns DnsZoneSoaRecordOutputReference
	_jsii_.Get(
		j,
		"soaRecord",
		&returns,
...
func (j *jsiiProxy_DnsZone) SoaRecordInput() *DnsZoneSoaRecord {
...
func (j *jsiiProxy_DnsZone) Tags() *map[string]*string {
...
func (j *jsiiProxy_DnsZone) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/dns_zone azurerm_dns_zone} Resource.
...
func (j *jsiiProxy_DnsZone)SetResourceGroupName(val *string) {
...
func (j *jsiiProxy_DnsZone)SetTags(val *map[string]*string) {
...
func (d *jsiiProxy_DnsZone) PutSoaRecord(value *DnsZoneSoaRecord) {
	if err := d.validatePutSoaRecordParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DnsZone) ResetSoaRecord() {
	_jsii_.InvokeVoid(
		d,
		"resetSoaRecord",
		nil, // no parameters
...
func (d *jsiiProxy_DnsZone) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
