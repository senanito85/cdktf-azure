...
import (
	...
	"github.com/hashicorp/terraform-cdk/examples/go/azure/generated/hashicorp/azurerm/virtualnetwork/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/virtual_network azurerm_virtual_network}.
type VirtualNetwork interface {
	...
	VmProtectionEnabled() interface{}
	SetVmProtectionEnabled(val interface{})
	VmProtectionEnabledInput() interface{}
...
func (j *jsiiProxy_VirtualNetwork) VmProtectionEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vmProtectionEnabled",
...
func (j *jsiiProxy_VirtualNetwork) VmProtectionEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vmProtectionEnabledInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/virtual_network azurerm_virtual_network} Resource.
func NewVirtualNetwork(scope constructs.Construct, id *string, config *VirtualNetworkConfig) VirtualNetwork {
	...
	_jsii_.Create(
		"azurerm.virtualNetwork.VirtualNetwork",
...
func (j *jsiiProxy_VirtualNetwork)SetVmProtectionEnabled(val interface{}) {
	if err := j.validateSetVmProtectionEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (v *jsiiProxy_VirtualNetwork) ResetVmProtectionEnabled() {
	_jsii_.InvokeVoid(
		v,
		"resetVmProtectionEnabled",
		nil, // no parameters
