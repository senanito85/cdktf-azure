...
import (
	...
	azure "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/provider"
...
func NewMyStack(scope constructs.Construct, id string) cdktf.TerraformStack {
	...
	azure.NewAzurermProvider(stack, jsii.String("azurerm"), &azure.AzurermProviderConfig{
		Features: &azure.AzurermProviderFeatures{},
	...
	*/
	...
	rg := resourcegroup.NewResourceGroup(stack, jsii.String("test_rg"), &resourcegroup.ResourceGroupConfig{
		...
		Name:     jsii.String("test-rg-sanan"),
		Location: jsii.String("australiasoutheast"),
	})
	...
	vm_nic := networkinterface.NewNetworkInterface(stack, jsii.String("test_vm_nic"), &networkinterface.NetworkInterfaceConfig{
		...
		IpConfiguration: &[]*networkinterface.NetworkInterfaceIpConfiguration{{
			...
			SubnetId:                   vm_nw_sn.Id(), //pass subnet id here if placing on existing subnet
